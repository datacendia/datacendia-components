...
$diodeSource = Test-Endpoint -Name "Register ingest source" -Method "POST" -Endpoint "/api/v1/sovereign-arch/diode/sources" -Body @{
...
$feedback = Test-Endpoint -Name "Record feedback" -Method "POST" -Endpoint "/api/v1/sovereign-arch/rlhf/feedback" -Body @{
...
if ($shadowSession -and $shadowSession.data) {
    ...
    $shadowDelib = Test-Endpoint -Name "Start shadow deliberation" -Method "POST" -Endpoint "/api/v1/sovereign-arch/shadow/sessions/$sessionId/deliberate" -Body @{
...
$captureSession = Test-Endpoint -Name "Start capture session" -Method "POST" -Endpoint "/api/v1/sovereign-arch/qr/capture/start" -Body @{}
...
$canary = Test-Endpoint -Name "Deploy canary" -Method "POST" -Endpoint "/api/v1/sovereign-arch/canary/deploy" -Body @{
...
$tpmKey = Test-Endpoint -Name "Initialize TPM" -Method "POST" -Endpoint "/api/v1/sovereign-arch/tpm/initialize"
...
$meshNode = Test-Endpoint -Name "Initialize mesh node" -Method "POST" -Endpoint "/api/v1/sovereign-arch/mesh/initialize" -Body @{
