...
export default function PricingPage() {
  ...
  const [commitment, setCommitment] = useState(commitmentOptions[1]);
  const [showRegionSelector, setShowRegionSelector] = useState(false);

  const formatPrice = (basePrice, region, commitment) => {
    let price = basePrice * region.multiplier * commitment.multiplier;
  ...
  const getMonthlyEquivalent = (basePrice, region, commitment) => {
    let price = basePrice * region.multiplier * commitment.multiplier / 12;
    ...
    <div style={{
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            We believe world-class decision intelligence should be accessible globally. 
            Our regional pricing reflects local market conditions.
          </p>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Large organization? Complex requirements? Government or education pricing? 
      ...
      <footer style={{
        ...
        <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: '14px' }}>
          ...
          <p style={{ margin: 0 }}>
            Questions? Contact sales@datacendia.com
          </p>
        </div>
      </footer>
    </div>
