...
export function cx(...classes: (string | undefined | null | false)[]): string {
  return stryMutAct_9fa48("580") ? classes.join(' ') : (stryCov_9fa48("580"), classes.filter(Boolean).join(' '));
}
...
export function getSeverityClasses(severity: 'critical' | 'high' | 'medium' | 'low'): string {
  const map = stryMutAct_9fa48("584") ? {} : (stryCov_9fa48("584"), {
...
export default stryMutAct_9fa48("589") ? {} : (stryCov_9fa48("589"), {
  colors,
  semantic,
  tw,
  presets,
