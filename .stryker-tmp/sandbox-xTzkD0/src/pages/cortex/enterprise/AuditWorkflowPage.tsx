...
const mockAudit: Audit = {
  ...
  tasks: [
    // Planning Phase
    { id: 'T001', title: 'Confirm audit scope with Deloitte', description: 'Review and finalize scope document', phase: 'planning', status: 'complete', assignee: 'Sarah Chen', dueDate: new Date('2026-01-20'), completedDate: new Date('2026-01-18') },
    { id: 'T002', title: 'Assign audit team members', description: 'Identify and assign roles', phase: 'planning', status: 'complete', assignee: 'Sarah Chen', dueDate: new Date('2026-01-22'), completedDate: new Date('2026-01-21') },
    { id: 'T003', title: 'Create master timeline', description: 'Build project plan with milestones', phase: 'planning', status: 'complete', assignee: 'Lisa Park', dueDate: new Date('2026-01-25'), completedDate: new Date('2026-01-24') },
    
    // Readiness Phase
    { id: 'T004', title: 'Council Deliberation: Risk Assessment', description: 'AI-assisted gap analysis across all controls', phase: 'readiness', status: 'complete', assignee: 'Mike Torres', dueDate: new Date('2026-02-01'), completedDate: new Date('2026-01-30') },
    { id: 'T005', title: 'Gap analysis by control domain', description: 'Document gaps per TSC category', phase: 'readiness', status: 'complete', assignee: 'Lisa Park', dueDate: new Date('2026-02-05'), completedDate: new Date('2026-02-04') },
    { id: 'T006', title: 'Create risk-ranked remediation list', description: 'Prioritize findings by risk score', phase: 'readiness', status: 'complete', assignee: 'Mike Torres', dueDate: new Date('2026-02-08'), completedDate: new Date('2026-02-07') },
    
    // Remediation Phase
    { id: 'T007', title: 'Address CC6.1 - Access Control gaps', description: 'Implement MFA for all admin accounts', phase: 'remediation', status: 'complete', assignee: 'James Wilson', dueDate: new Date('2026-02-20'), completedDate: new Date('2026-02-18') },
    { id: 'T008', title: 'Address CC7.2 - Monitoring gaps', description: 'Deploy enhanced logging', phase: 'remediation', status: 'in-progress', assignee: 'James Wilson', dueDate: new Date('2026-02-25') },
    { id: 'T009', title: 'Update security policies', description: 'Revise and publish updated policies', phase: 'remediation', status: 'in-progress', assignee: 'Lisa Park', dueDate: new Date('2026-02-28') },
    { id: 'T010', title: 'Begin evidence gathering', description: 'Collect screenshots, logs, configs', phase: 'remediation', status: 'pending', assignee: 'Lisa Park', dueDate: new Date('2026-03-01') },
    
    // Mock Audit
    { id: 'T011', title: 'Internal walkthrough - Security', description: 'Security control testing', phase: 'mock-audit', status: 'pending', assignee: 'Mike Torres', dueDate: new Date('2026-03-20') },
    { id: 'T012', title: 'Internal walkthrough - Operations', description: 'Ops control testing', phase: 'mock-audit', status: 'pending', assignee: 'James Wilson', dueDate: new Date('2026-03-22') },
    { id: 'T013', title: 'Finding simulation', description: 'Document potential findings', phase: 'mock-audit', status: 'pending', assignee: 'Lisa Park', dueDate: new Date('2026-03-25') },
    
    // Final Prep
    { id: 'T014', title: 'Evidence package complete', description: 'All evidence organized and verified', phase: 'final-prep', status: 'pending', assignee: 'Lisa Park', dueDate: new Date('2026-04-01') },
    { id: 'T015', title: 'Team briefing', description: 'Final prep meeting with all stakeholders', phase: 'final-prep', status: 'pending', assignee: 'Sarah Chen', dueDate: new Date('2026-04-05') },
    { id: 'T016', title: 'Logistics confirmed', description: 'Meeting rooms, access, schedules', phase: 'final-prep', status: 'pending', assignee: 'Sarah Chen', dueDate: new Date('2026-04-08') },
    
    // Execution
    { id: 'T017', title: 'Daily standup - Day 1', description: 'Morning sync with audit team', phase: 'execution', status: 'pending', assignee: 'Sarah Chen', dueDate: new Date('2026-04-15') },
    { id: 'T018', title: 'Evidence request responses', description: 'Respond to auditor requests within SLA', phase: 'execution', status: 'pending', assignee: 'Lisa Park', dueDate: new Date('2026-04-18') },
    
    // Closeout
    { id: 'T019', title: 'Exit meeting', description: 'Review preliminary findings', phase: 'closeout', status: 'pending', assignee: 'Sarah Chen', dueDate: new Date('2026-04-22') },
    { id: 'T020', title: 'Management response', description: 'Draft responses to findings', phase: 'closeout', status: 'pending', assignee: 'Lisa Park', dueDate: new Date('2026-04-25') },
    { id: 'T021', title: 'Lessons learned', description: 'Document improvements for next audit', phase: 'closeout', status: 'pending', assignee: 'Sarah Chen', dueDate: new Date('2026-04-30') },
  ],
  findings: [
    { id: 'F001', title: 'MFA not enforced for service accounts', description: 'Several service accounts lack MFA', severity: 'high', control: 'CC6.1', status: 'remediated', assignee: 'James Wilson', dueDate: new Date('2026-02-20'), remediation: 'Implemented MFA for all service accounts' },
    { id: 'F002', title: 'Log retention below 12 months', description: 'Current retention is 6 months', severity: 'medium', control: 'CC7.2', status: 'open', assignee: 'James Wilson', dueDate: new Date('2026-02-25') },
    { id: 'F003', title: 'Incident response plan outdated', description: 'Last updated 18 months ago', severity: 'medium', control: 'CC7.4', status: 'open', assignee: 'Lisa Park', dueDate: new Date('2026-02-28') },
  ],
};
...
const getStatusColor = (status: TaskStatus) => {
  switch (status) {
    ...
    case 'pending': return 'bg-neutral-500/20 text-neutral-400 border-neutral-500/30';
    case 'blocked': return 'bg-red-500/20 text-red-400 border-red-500/30';
    case 'not-applicable': return 'bg-neutral-700/20 text-neutral-500 border-neutral-700/30';
  }
};
...
const getSeverityColor = (severity: FindingSeverity) => {
  switch (severity) {
    ...
    case 'informational': return 'bg-neutral-500/20 text-neutral-400';
  }
};
...
export const AuditWorkflowPage: React.FC = () => {
  ...
  const filteredTasks = selectedPhase === 'all' 
    ? audit.tasks 
    : audit.tasks.filter(t => t.phase === selectedPhase);
                ...
                <React.Fragment key={phase.id}>
                  ...
                  >
                    <div className={`w-16 h-16 rounded-full flex items-center justify-center text-2xl border-2 transition-all ${
                      idx < currentPhaseIndex ? 'bg-green-500/20 border-green-500' :
                      idx === currentPhaseIndex ? 'bg-primary-500/20 border-primary-500 animate-pulse' :
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-neutral-800 rounded-xl border border-neutral-700 p-6">
              ...
              {audit.findings.filter(f => f.status === 'open').length === 0 ? (
                ...
                <div className="space-y-3">
                  {audit.findings.filter(f => f.status === 'open').map(finding => (
                    <div key={finding.id} className="p-3 bg-neutral-900 rounded-lg border border-neutral-700">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex gap-4">
              {['critical', 'high', 'medium', 'low'].map(severity => {
                ...
                return (
                  <div key={severity} className={`px-4 py-2 rounded-lg ${getSeverityColor(severity as FindingSeverity)}`}>
            ...
            <table className="w-full">
              ...
              <tbody>
                {audit.findings.map(finding => (
                  <tr key={finding.id} className="border-t border-neutral-700 hover:bg-neutral-700/50 cursor-pointer transition-colors">
                    ...
                    <td className="p-4">
                      <span className={`px-2 py-1 rounded text-xs font-medium ${
                        finding.status === 'remediated' ? 'bg-green-500/20 text-green-400' :
                        finding.status === 'open' ? 'bg-yellow-500/20 text-yellow-400' :
      ...
      {activeTab === 'council' && (
        <div className="space-y-6">
          ...
          <div className="bg-neutral-800 rounded-xl border border-neutral-700 p-6">
            ...
            <div className="space-y-3">
              {[
                { query: 'Risk assessment for CC7.2 monitoring gaps', date: '2 days ago', confidence: 87 },
                { query: 'Evidence requirements for access control', date: '5 days ago', confidence: 92 },
                { query: 'Remediation timeline feasibility', date: '1 week ago', confidence: 78 },
              ].map((delib, idx) => (
                <div key={idx} className="p-4 bg-neutral-900 rounded-lg flex items-center justify-between">
                  <div>
