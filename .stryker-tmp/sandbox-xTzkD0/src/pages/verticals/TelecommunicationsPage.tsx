...
const agents = [
  { code: 'network', name: 'Network Operations', purpose: 'Capacity planning, outage management, performance optimization', model: 'qwq:32b' },
  { code: 'customer-telecom', name: 'Customer Intelligence', purpose: 'Churn prediction, lifetime value, retention strategy', model: 'llama3.3:70b' },
  { code: 'spectrum', name: 'Spectrum Manager', purpose: 'Spectrum allocation, 5G planning, regulatory compliance', model: 'qwq:32b' },
  { code: 'revenue-telecom', name: 'Revenue Assurance', purpose: 'Billing accuracy, fraud detection, revenue optimization', model: 'llama3.3:70b' },
];

const compliance = ['FCC Regulations', 'CPNI Privacy', 'E911', 'Accessibility (ADA)', 'Net Neutrality', 'Spectrum Licensing', 'International Roaming'];

const pricing = [
  { package: 'Telecom Starter', price: '$100,000', includes: '8 Pillars + 4 Telecom Agents', roi: '6 months' },
  { package: 'Telecom Professional', price: '$800,000', includes: '+ Predict, Aegis, Panopticon', roi: '4 months' },
  { package: 'Telecom Enterprise', price: '$4,000,000', includes: '+ Full Guardian Suite', roi: '3 months' },
  { package: 'Telecom Sovereign', price: '$12,000,000+', includes: '+ Carrier-scale, custom', roi: '2 months' },
];
          ...
          <div className="space-y-12">
            ...
            <section>
              ...
              <div className="grid grid-cols-3 gap-6">
                {[
                  { title: 'Network Intelligence', desc: 'AI-powered capacity planning, outage prediction, and performance optimization across your network', icon: '🌐' },
                  { title: 'Churn Prevention', desc: 'Predict customer churn with 85% accuracy and trigger proactive retention interventions', icon: '👥' },
                  { title: 'Revenue Assurance', desc: 'Detect billing anomalies, reduce revenue leakage, and optimize pricing strategies', icon: '💰' },
                ].map(item => (
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-2">
                {compliance.map(c => (
                  <span key={c} className="px-4 py-2 bg-teal-500/10 text-teal-400 rounded-lg border border-teal-500/30 font-medium">{c}</span>
                ))}
              </div>
            </section>
          </div>
          ...
          <div className="space-y-12">
            <section>
              ...
              <div className="grid grid-cols-2 gap-6">
                {agents.map(agent => (
                  <div key={agent.code} className="bg-neutral-800 rounded-xl p-6 border border-neutral-700 opacity-75">
