...
const agents = [
  { code: 'content', name: 'Content Strategist', purpose: 'Programming decisions, content acquisition, greenlight analysis', model: 'llama3.3:70b' },
  { code: 'audience', name: 'Audience Analyst', purpose: 'Viewership prediction, engagement optimization, demographic insights', model: 'qwq:32b' },
  { code: 'rights', name: 'Rights Manager', purpose: 'Licensing deals, IP valuation, distribution strategy', model: 'qwq:32b' },
  { code: 'ad-ops', name: 'Ad Operations', purpose: 'Inventory optimization, yield management, programmatic strategy', model: 'llama3.3:70b' },
];

const compliance = ['FCC Regulations', 'COPPA', 'Advertising Standards', 'Content Ratings', 'Music Licensing', 'SAG-AFTRA', 'International Distribution'];

const pricing = [
  { package: 'Media Starter', price: '$70,000', includes: '8 Pillars + 4 Media Agents', roi: '6 months' },
  { package: 'Media Professional', price: '$600,000', includes: '+ Predict, Crucible, Eternal', roi: '4 months' },
  { package: 'Media Enterprise', price: '$3,000,000', includes: '+ Full Guardian Suite', roi: '3 months' },
  { package: 'Media Sovereign', price: '$8,000,000+', includes: '+ Studio-scale, custom', roi: '2 months' },
];
          ...
          <div className="space-y-12">
            <section>
              ...
              <div className="grid grid-cols-3 gap-6">
                {[
                  { title: 'Greenlight Intelligence', desc: 'AI-powered content investment decisions with audience prediction, comp analysis, and risk modeling', icon: '🎯' },
                  { title: 'Audience Analytics', desc: 'Real-time viewership prediction, engagement optimization, and demographic insights across platforms', icon: '👥' },
                  { title: 'Rights Optimization', desc: 'IP valuation, licensing strategy, and distribution window optimization with full audit trail', icon: '📜' },
                ].map(item => (
            ...
            <section>
              ...
              <div className="space-y-4">
                {[
                  { org: 'Streaming Platform', quote: 'Content ROI improved 35% by predicting audience response before greenlight. The Council identified 3 shows our team was wrong about.', metric: '35% better ROI' },
                  { org: 'Broadcast Network', quote: 'Ad yield optimization increased revenue 24% without adding inventory. AI found pricing opportunities we were leaving on the table.', metric: '24% ad yield' },
                  { org: 'Production Studio', quote: 'Greenlight decisions that took 6 weeks now happen in 6 days with complete market analysis and risk assessment.', metric: '6wk → 6d' },
                ].map((cs, idx) => (
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-2">
                {compliance.map(c => (
                  <span key={c} className="px-4 py-2 bg-fuchsia-500/10 text-fuchsia-400 rounded-lg border border-fuchsia-500/30 font-medium">{c}</span>
                ))}
              </div>
            </section>
          </div>
