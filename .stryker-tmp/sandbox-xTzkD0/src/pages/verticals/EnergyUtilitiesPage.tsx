...
const agents = [
  { code: 'grid-ops', name: 'Grid Operations', purpose: 'Load balancing, outage management, renewable integration', model: 'qwq:32b' },
  { code: 'regulatory-energy', name: 'Regulatory Manager', purpose: 'Rate cases, PUC filings, compliance tracking', model: 'llama3.3:70b' },
  { code: 'asset-mgr', name: 'Asset Manager', purpose: 'Infrastructure planning, maintenance optimization, lifecycle', model: 'qwq:32b' },
  { code: 'trading', name: 'Trading Analyst', purpose: 'Energy trading, hedging strategy, market analysis', model: 'llama3.3:70b' },
];

const compliance = ['NERC CIP', 'FERC', 'EPA', 'State PUC', 'ISO/RTO Rules', 'OSHA', 'Clean Air Act', 'Renewable Standards'];

const pricing = [
  { package: 'Energy Starter', price: '$120,000', includes: '8 Pillars + 4 Energy Agents', roi: '8 months' },
  { package: 'Energy Professional', price: '$1,200,000', includes: '+ Panopticon, Aegis, Crucible', roi: '5 months' },
  { package: 'Energy Enterprise', price: '$6,000,000', includes: '+ Full Guardian Suite', roi: '3 months' },
  { package: 'Energy Sovereign', price: '$15,000,000+', includes: '+ Grid-scale, SCADA secure', roi: '2 months' },
];
          ...
          <div className="space-y-12">
            <section>
              ...
              <div className="grid grid-cols-3 gap-6">
                {[
                  { title: 'NERC CIP Compliant', desc: 'Full compliance with critical infrastructure protection standards, air-gapped deployment option', icon: '🔒' },
                  { title: 'Energy Transition Ready', desc: 'AI-powered renewable integration, storage optimization, and grid balancing', icon: '🌱' },
                  { title: 'Rate Case Acceleration', desc: '45% faster preparation with automated evidence gathering and analysis', icon: '📋' },
                ].map(item => (
            ...
            <section>
              ...
              <div className="space-y-4">
                {[
                  { org: 'Investor-Owned Utility', quote: 'Rate case preparation time cut by 45%. The Council assembled evidence from 12 systems that took our team months to compile manually.', metric: '45% faster' },
                  { org: 'Regional Transmission Org', quote: 'Grid reliability decisions now happen in real-time instead of weekly planning meetings.', metric: 'Real-time decisions' },
                  { org: 'Renewable Developer', quote: 'Interconnection queue decisions accelerated by 60%. We can evaluate 3x more projects per quarter.', metric: '3x throughput' },
                ].map((cs, idx) => (
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-2">
                {compliance.map(c => (
                  <span key={c} className="px-4 py-2 bg-yellow-500/10 text-yellow-400 rounded-lg border border-yellow-500/30 font-medium">{c}</span>
                ))}
              </div>
            </section>
          </div>
