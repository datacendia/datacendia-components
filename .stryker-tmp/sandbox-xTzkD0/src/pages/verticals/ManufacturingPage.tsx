...
const agents = [
  { code: 'vp-ops', name: 'VP Operations', purpose: 'Production planning, capacity optimization, lean initiatives', model: 'llama3.3:70b' },
  { code: 'supply-chain', name: 'Supply Chain Director', purpose: 'Supplier management, logistics optimization, risk mitigation', model: 'qwq:32b' },
  { code: 'quality', name: 'Quality Manager', purpose: 'Quality control, compliance, continuous improvement', model: 'qwq:32b' },
  { code: 'plant', name: 'Plant Manager', purpose: 'Shop floor operations, workforce planning, safety', model: 'llama3.3:70b' },
];

const compliance = ['ISO 9001', 'IATF 16949', 'AS9100', 'OSHA', 'EPA', 'FDA cGMP', 'ISO 14001', 'ISO 45001'];

const pricing = [
  { package: 'Manufacturing Starter', price: '$80,000', includes: '8 Pillars + 4 Mfg Agents', roi: '8 months' },
  { package: 'Manufacturing Professional', price: '$600,000', includes: '+ Panopticon, Crucible, Mesh', roi: '5 months' },
  { package: 'Manufacturing Enterprise', price: '$3,000,000', includes: '+ Full Guardian Suite', roi: '3 months' },
  { package: 'Manufacturing Sovereign', price: '$8,000,000+', includes: '+ Multi-plant, OT security', roi: '2 months' },
];
          ...
          <div className="space-y-12">
            <section>
              ...
              <div className="grid grid-cols-3 gap-6">
                {[
                  { title: 'Supply Chain Resilience', desc: 'AI-powered supplier risk monitoring with automatic alternative sourcing recommendations', icon: '🔗' },
                  { title: 'OT/IT Convergence', desc: 'Secure integration with shop floor systems while maintaining air-gap for sensitive operations', icon: '🔒' },
                  { title: 'Inventory Optimization', desc: 'Dynamic safety stock and reorder point optimization based on demand signals', icon: '📦' },
                ].map(item => (
            ...
            <section>
              ...
              <div className="space-y-4">
                {[
                  { org: 'Auto Supplier (Tier 1)', quote: 'Reduced inventory by 23%, freeing $1.4M in working capital. Council identified 12 SKUs we were over-stocking.', metric: '$1.4M freed' },
                  { org: 'Aerospace Manufacturer', quote: 'Supply chain disruption response time cut from 2 weeks to 2 days. We had alternatives ready before competitors knew there was a problem.', metric: '2wk → 2d' },
                  { org: 'Consumer Goods Company', quote: 'OEE improved 12% by identifying bottlenecks our MES wasn\'t surfacing.', metric: '12% OEE gain' },
                ].map((cs, idx) => (
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-2">
                {compliance.map(c => (
                  <span key={c} className="px-4 py-2 bg-amber-500/10 text-amber-400 rounded-lg border border-amber-500/30 font-medium">{c}</span>
                ))}
              </div>
            </section>
          </div>
