...
export const ShowcasesPage: React.FC = () => {
  ...
  const industries = ['all', 'Financial Services', 'Healthcare', 'Manufacturing', 'Retail', 'Energy & Utilities'];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {activeTab === 'stories' && (
            <>
              ...
              <div className="space-y-8">
                {filteredCaseStudies.filter(cs => cs.featured).map((study) => (
                    ...
                    <div className="p-8">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                        {study.results.map((result) => (
                          <div key={result.metric} className="bg-neutral-50 rounded-lg p-4 text-center">
              ...
              <div className="grid md:grid-cols-2 gap-6 mt-8">
                {filteredCaseStudies.filter(cs => !cs.featured).map((study) => (
                  <div key={study.id} className="bg-white rounded-xl border border-neutral-200 p-6">
          ...
          {activeTab === 'usecases' && (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {useCases.map((useCase) => (
                <div key={useCase.id} className="bg-white rounded-xl border border-neutral-200 p-6 hover:shadow-lg transition-shadow">
                  <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="pt-4 border-t border-neutral-100">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {useCase.outcomes.slice(0, 2).map((outcome) => (
                        <span key={outcome} className="px-2 py-1 bg-success-50 text-success-700 text-xs rounded">
                          {outcome}
                        </span>
                      ))}
                    </div>
          ...
          {activeTab === 'demos' && (
            <>
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {demos.map((demo) => (
                  <div key={demo.id} className="bg-white rounded-xl border border-neutral-200 overflow-hidden hover:shadow-lg transition-shadow group cursor-pointer">
