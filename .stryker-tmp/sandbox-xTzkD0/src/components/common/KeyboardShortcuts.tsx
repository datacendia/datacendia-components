...
const KeyboardShortcutsProvider: React.FC<KeyboardShortcutsProps & { children: React.ReactNode }> = ({
  children,
  onQuickSearch,
  onSubmit,
  onNewDeliberation,
...
const QuickSearch: React.FC<{
  ...
  useEffect(() => {
    if (query.length > 0) {
      // Mock search results
      const mockResults = [
        { type: 'deliberation', title: 'Q1 Growth Strategy Analysis', path: '/cortex/council/del-001' },
        { type: 'deliberation', title: 'Market Expansion Risk Assessment', path: '/cortex/council/del-002' },
