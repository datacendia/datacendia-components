...
export const SovereignEnterpriseIntelligencePage: React.FC = () => {
  return <div className="min-h-screen bg-black text-white font-light antialiased">
      {/* Navigation */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              <Link to="/product" className="text-xs tracking-wider text-slate-400 hover:text-white transition-colors">PRODUCT</Link>
              <Link to="/honesty" className="text-xs tracking-wider text-slate-400 hover:text-white transition-colors">HONESTY</Link>
              <Link to="/pricing" className="text-xs tracking-wider text-slate-400 hover:text-white transition-colors">PRICING</Link>
            </div>
            <Link to="/demo" className="px-5 py-2 bg-amber-500 text-black text-sm font-bold rounded hover:bg-amber-400 transition-colors">
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-xs tracking-[0.4em] text-amber-500 uppercase mb-6">CATEGORY DEFINITION</p>
  ...
  modelZoo: SovereignModelZoo;
      ...
      <section className="py-16 border-t border-white/5">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-2xl font-light text-center mb-12">Why Existing Tools Don't Cover the Decision Layer</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-slate-900/30 border border-slate-800 p-6 rounded-lg">
              ...
              <p className="text-slate-500 text-xs">
                <span className="text-red-400">Missing:</span> Why it happened. Who decided. What alternatives existed.
              </p>
            </div>
            ...
            <div className="bg-slate-900/30 border border-slate-800 p-6 rounded-lg">
              ...
              <p className="text-slate-500 text-xs">
                <span className="text-red-400">Missing:</span> Multi-agent debate. Dissent tracking. Audit-ready explainability.
              </p>
            </div>
            ...
            <div className="bg-slate-900/30 border border-slate-800 p-6 rounded-lg">
              ...
              <p className="text-slate-500 text-xs">
                <span className="text-red-400">Missing:</span> Governance layer. Sovereignty. Evidence preservation. Council deliberation.
              </p>
            </div>
          </div>
          
          <p className="text-center text-slate-500 mt-8 text-sm">
            SEI sits <em>above</em> these tools. It's the decision layer that governs how intelligence flows into action.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex gap-4 p-6 bg-black/50 border border-slate-800 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">
                  Replay any moment in your organization's history. See exactly what was known, decided, and why. 
                  CendiaChronos™ makes audits trivial.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-6 bg-black/50 border border-slate-800 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">
                  CendiaCrucible™ runs 10,000+ Monte Carlo simulations. Stress-test decisions before you make them.
                  See what breaks.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-6 bg-black/50 border border-slate-800 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">
                  Immutable audit trail. Formal dissent protocol. Stakeholder visibility. 
                  Built for regulators, boards, and "show me why" moments.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-6 bg-black/50 border border-slate-800 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">
                  CendiaPanopticon™ maps who cares about what. Surface concerns before they become crises.
                  Radical transparency as a feature.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-6 bg-black/50 border border-slate-800 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">
                  Your models. Your infrastructure. Role-specialized agents (CFO uses different models than Coder).
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-slate-900/30 border border-slate-800 rounded-lg p-8 font-mono text-sm">
            ...
            <p className="text-slate-500 mt-6 text-xs">
              SEI doesn't replace your existing stack. It sits on top, governing how intelligence flows into decisions.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 border-t border-white/5 bg-slate-950/50">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-center text-slate-500 mb-12 max-w-2xl mx-auto">
            Organizations where decisions have consequences—and where "we don't know why we decided that" is unacceptable.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 border border-slate-800 rounded-lg">
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li>• <strong className="text-white">Financial Services</strong> — Banks, asset managers, insurers</li>
                <li>• <strong className="text-white">Healthcare</strong> — Hospital systems, pharma, payers</li>
                <li>• <strong className="text-white">Government</strong> — Federal, state, defense, intelligence</li>
                <li>• <strong className="text-white">Critical Infrastructure</strong> — Energy, utilities, transport</li>
                <li>• <strong className="text-white">Regulated Enterprise</strong> — Any org with compliance obligations</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 border-t border-white/5">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <p className="text-slate-500 text-sm mb-6">Datacendia is one implementation of this layer.</p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/demo" className="px-8 py-4 bg-amber-500 text-black font-bold rounded hover:bg-amber-400 transition-colors flex items-center justify-center gap-2">
              Request Early Access <ArrowRight size={18} />
            </Link>
            <Link to="/honesty" className="px-8 py-4 border border-slate-700 text-white rounded hover:bg-slate-900 transition-colors">
