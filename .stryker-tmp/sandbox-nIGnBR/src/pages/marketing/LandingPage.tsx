...
import { Shield, Brain, Globe, Zap, Users, Lock, ArrowRight, CheckCircle2, ChevronDown, Menu, X, Database, Activity, Eye, Scale, MessageSquare, BarChart3, Play } from 'lucide-react';
const LandingPage = () => {
  const navigate = useNavigate();
  const [isMenuOpen, setIsMenuOpen] = useState(stryMutAct_9fa48("50751") ? true : (stryCov_9fa48("50751"), false));
  const [activeRegion, setActiveRegion] = useState('US');
  const regions: Record<string, {
    label: string;
    symbol: string;
    multiplier: number;
  }> = stryMutAct_9fa48("50753") ? {} : (stryCov_9fa48("50753"), {
    'US': stryMutAct_9fa48("50754") ? {} : (stryCov_9fa48("50754"), {
      label: 'United States',
      symbol: '$',
      multiplier: 1
    }),
    'EU': stryMutAct_9fa48("50757") ? {} : (stryCov_9fa48("50757"), {
      label: 'Europe',
      symbol: '€',
      multiplier: 0.9
    }),
    'LATAM': stryMutAct_9fa48("50760") ? {} : (stryCov_9fa48("50760"), {
      label: 'Latin America',
      symbol: '$',
      multiplier: 0.4
    }),
    'ASIA': stryMutAct_9fa48("50763") ? {} : (stryCov_9fa48("50763"), {
      label: 'Asia',
      symbol: '$',
      multiplier: 0.6
    })
  });
  const pricing: Record<string, Record<string, number>> = stryMutAct_9fa48("50766") ? {} : (stryCov_9fa48("50766"), {
    starter: stryMutAct_9fa48("50767") ? {} : (stryCov_9fa48("50767"), {
      US: 299,
      EU: 279,
      LATAM: 99,
      ASIA: 149
    }),
    growth: stryMutAct_9fa48("50768") ? {} : (stryCov_9fa48("50768"), {
      US: 799,
      EU: 749,
      LATAM: 299,
      ASIA: 399
    }),
    business: stryMutAct_9fa48("50769") ? {} : (stryCov_9fa48("50769"), {
      US: 1999,
      EU: 1899,
      LATAM: 799,
      ASIA: 999
  ...
  const [showVideo, setShowVideo] = useState(stryMutAct_9fa48("50770") ? true : (stryCov_9fa48("50770"), false));
  const pillars = stryMutAct_9fa48("50771") ? [] : (stryCov_9fa48("50771"), [stryMutAct_9fa48("50772") ? {} : (stryCov_9fa48("50772"), {
    name: 'CendiaLineage™',
    icon: Database,
    desc: 'Memory & Truth',
    path: '/cortex/pillars/lineage'
  }), stryMutAct_9fa48("50776") ? {} : (stryCov_9fa48("50776"), {
    name: 'CendiaGuard™',
    icon: Shield,
    desc: 'Immune System',
    path: '/cortex/pillars/guard'
  }), stryMutAct_9fa48("50780") ? {} : (stryCov_9fa48("50780"), {
    name: 'CendiaHelm™',
    icon: MessageSquare,
    ...
    desc: 'The Pulse',
    path: '/cortex/pulse'
  }), stryMutAct_9fa48("50788") ? {} : (stryCov_9fa48("50788"), {
    name: 'CendiaHealth™',
    icon: Activity,
    desc: 'Nervous System',
    path: '/cortex/pillars/health'
  }), stryMutAct_9fa48("50792") ? {} : (stryCov_9fa48("50792"), {
    name: 'CendiaPredict™',
    icon: Eye,
    desc: 'Imagination',
    path: '/cortex/pillars/predict'
  }), stryMutAct_9fa48("50796") ? {} : (stryCov_9fa48("50796"), {
    name: 'CendiaEthics™',
    icon: Scale,
    desc: 'Conscience',
    path: '/cortex/pillars/ethics'
  }), stryMutAct_9fa48("50800") ? {} : (stryCov_9fa48("50800"), {
    name: 'CendiaFlow™',
    icon: Zap,
    desc: 'Hands & Action',
    path: '/cortex/pillars/flow'
  })]);
  return <div className="min-h-screen bg-black text-slate-200 font-sans selection:bg-amber-500/30 selection:text-amber-200">
      ...
      <nav className="fixed w-full z-50 bg-black/80 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="-mr-2 flex md:hidden">
              <button onClick={stryMutAct_9fa48("50804") ? () => undefined : (stryCov_9fa48("50804"), () => setIsMenuOpen(stryMutAct_9fa48("50805") ? isMenuOpen : (stryCov_9fa48("50805"), !isMenuOpen)))} className="text-gray-400 hover:text-white p-2">
                {isMenuOpen ? <X /> : <Menu />}
              </button>
            </div>
          </div>
        ...
        {/* Mobile menu */}
        {stryMutAct_9fa48("50808") ? isMenuOpen || <div className="md:hidden bg-slate-900 border-b border-white/10">
          ...
          </div> : stryMutAct_9fa48("50807") ? false : stryMutAct_9fa48("50806") ? true : (stryCov_9fa48("50806", "50807", "50808"), isMenuOpen && <div className="md:hidden bg-slate-900 border-b border-white/10">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <a href="#philosophy" onClick={stryMutAct_9fa48("50809") ? () => undefined : (stryCov_9fa48("50809"), () => setIsMenuOpen(stryMutAct_9fa48("50810") ? true : (stryCov_9fa48("50810"), false)))} className="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-white/10">Philosophy</a>
              <a href="#cortex" onClick={stryMutAct_9fa48("50811") ? () => undefined : (stryCov_9fa48("50811"), () => setIsMenuOpen(stryMutAct_9fa48("50812") ? true : (stryCov_9fa48("50812"), false)))} className="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-white/10">The Cortex</a>
              <a href="#pricing" onClick={stryMutAct_9fa48("50813") ? () => undefined : (stryCov_9fa48("50813"), () => setIsMenuOpen(stryMutAct_9fa48("50814") ? true : (stryCov_9fa48("50814"), false)))} className="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-white/10">Pricing</a>
              <Link to="/apex/forecast" onClick={stryMutAct_9fa48("50815") ? () => undefined : (stryCov_9fa48("50815"), () => setIsMenuOpen(stryMutAct_9fa48("50816") ? true : (stryCov_9fa48("50816"), false)))} className="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-white/10">Services</Link>
              <Link to="/contact" onClick={stryMutAct_9fa48("50817") ? () => undefined : (stryCov_9fa48("50817"), () => setIsMenuOpen(stryMutAct_9fa48("50818") ? true : (stryCov_9fa48("50818"), false)))} className="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-white/10">Contact</Link>
              <Link to="/about" onClick={stryMutAct_9fa48("50819") ? () => undefined : (stryCov_9fa48("50819"), () => setIsMenuOpen(stryMutAct_9fa48("50820") ? true : (stryCov_9fa48("50820"), false)))} className="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-white/10">About</Link>
              <div className="border-t border-white/10 mt-2 pt-2">
                <Link to="/login" onClick={stryMutAct_9fa48("50821") ? () => undefined : (stryCov_9fa48("50821"), () => setIsMenuOpen(stryMutAct_9fa48("50822") ? true : (stryCov_9fa48("50822"), false)))} className="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-white/10">Login</Link>
                <Link to="/demo" onClick={stryMutAct_9fa48("50823") ? () => undefined : (stryCov_9fa48("50823"), () => setIsMenuOpen(stryMutAct_9fa48("50824") ? true : (stryCov_9fa48("50824"), false)))} className="block px-3 py-2 rounded-md text-base font-medium bg-amber-500 text-black mt-2">Get Started</Link>
              </div>
            </div>
          </div>)}
      </nav>
      ...
      <div className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-12 flex flex-col sm:flex-row justify-center gap-4">
            <button onClick={stryMutAct_9fa48("50825") ? () => undefined : (stryCov_9fa48("50825"), () => navigate('/demo'))} className="bg-amber-500 hover:bg-amber-400 text-black px-8 py-4 rounded font-bold text-lg transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(245,158,11,0.3)] hover:shadow-[0_0_30px_rgba(245,158,11,0.5)]">
              Request Early Access <ArrowRight size={20} />
            </button>
            <button onClick={stryMutAct_9fa48("50827") ? () => undefined : (stryCov_9fa48("50827"), () => setShowVideo(stryMutAct_9fa48("50828") ? false : (stryCov_9fa48("50828"), true)))} className="group border border-white/20 hover:border-white text-white px-8 py-4 rounded font-medium text-lg transition-all flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 backdrop-blur-sm">
          ...
          <div className="mt-16 pt-8 border-t border-white/5 flex flex-wrap justify-center gap-8 md:gap-16 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
             {(stryMutAct_9fa48("50829") ? [] : (stryCov_9fa48("50829"), ['FINANCE', 'HEALTHCARE', 'GOVERNMENT', 'MANUFACTURING'])).map(stryMutAct_9fa48("50834") ? () => undefined : (stryCov_9fa48("50834"), sector => <span key={sector} className="text-sm font-mono font-bold tracking-widest">{sector} READY</span>))}
          </div>
        </div>
      </div>
      ...
      <section id="philosophy" className="py-24 bg-slate-950 relative border-y border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {pillars.map(stryMutAct_9fa48("50835") ? () => undefined : (stryCov_9fa48("50835"), (pillar, i) => <Link key={i} to={pillar.path} className="group p-6 bg-black border border-white/10 hover:border-amber-500/50 hover:bg-white/5 transition-all rounded-lg cursor-pointer relative overflow-hidden">
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            <div className="mb-12 lg:mb-0">
              ...
              <ul className="space-y-4 mb-8">
                {(stryMutAct_9fa48("50836") ? [] : (stryCov_9fa48("50836"), ['Multi-agent debate protocols', 'Blocking concerns (e.g., Security vetos)', 'Full reasoning lineage', 'Ethical guardrails built-in'])).map(stryMutAct_9fa48("50841") ? () => undefined : (stryCov_9fa48("50841"), (item, i) => <li key={i} className="flex items-center gap-3 text-slate-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <div className="inline-flex bg-black border border-white/10 rounded-lg p-1">
              {Object.keys(regions).map(stryMutAct_9fa48("50842") ? () => undefined : (stryCov_9fa48("50842"), r => <button key={r} onClick={stryMutAct_9fa48("50843") ? () => undefined : (stryCov_9fa48("50843"), () => setActiveRegion(r))} className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${(stryMutAct_9fa48("50847") ? activeRegion !== r : stryMutAct_9fa48("50846") ? false : stryMutAct_9fa48("50845") ? true : (stryCov_9fa48("50845", "50846", "50847"), activeRegion === r)) ? 'bg-white text-black shadow-lg' : 'text-slate-400 hover:text-white'}`}>
                  {r}
                </button>))}
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-black border border-white/10 p-8 rounded-xl hover:border-white/20 transition-all flex flex-col">
              ...
              <button onClick={stryMutAct_9fa48("50850") ? () => undefined : (stryCov_9fa48("50850"), () => navigate('/demo'))} className="w-full py-3 border border-white/20 rounded hover:bg-white hover:text-black transition-colors font-medium">Start Free Trial</button>
            </div>
            ...
            <div className="bg-slate-900 border border-amber-500/50 p-8 rounded-xl relative flex flex-col shadow-[0_0_30px_rgba(245,158,11,0.1)]">
              ...
              <button onClick={stryMutAct_9fa48("50852") ? () => undefined : (stryCov_9fa48("50852"), () => navigate('/demo'))} className="w-full py-3 bg-amber-500 rounded hover:bg-amber-400 text-black font-bold transition-colors">Get Started</button>
            </div>
            ...
            <div className="bg-black border border-white/10 p-8 rounded-xl hover:border-white/20 transition-all flex flex-col">
              ...
              <button onClick={stryMutAct_9fa48("50854") ? () => undefined : (stryCov_9fa48("50854"), () => navigate('/contact'))} className="w-full py-3 border border-white/20 rounded hover:bg-white hover:text-black transition-colors font-medium">Contact Sales</button>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Video Modal */}
      {stryMutAct_9fa48("50858") ? showVideo || <div className="fixed inset-0 z-[100] bg-black/90 backdrop-blur-sm flex items-center justify-center p-4" onClick={() => setShowVideo(false)}>
          <div className="relative w-full max-w-4xl" onClick={e => e.stopPropagation()}>
            <button onClick={() => setShowVideo(false)} className="absolute -top-12 right-0 text-white hover:text-amber-500 transition-colors">
              <X size={32} />
            </button>
            <div className="aspect-video bg-slate-900 rounded-xl overflow-hidden border border-white/10">
              ...
              <div className="w-full h-full flex flex-col items-center justify-center text-center p-8">
                ...
                <Link to="/demo" className="px-6 py-3 bg-amber-500 text-black font-bold rounded hover:bg-amber-400 transition-colors" onClick={() => setShowVideo(false)}>
                  Request Live Demo
                </Link>
              </div>
            </div>
          </div>
        </div> : stryMutAct_9fa48("50857") ? false : stryMutAct_9fa48("50856") ? true : (stryCov_9fa48("50856", "50857", "50858"), showVideo && <div className="fixed inset-0 z-[100] bg-black/90 backdrop-blur-sm flex items-center justify-center p-4" onClick={stryMutAct_9fa48("50859") ? () => undefined : (stryCov_9fa48("50859"), () => setShowVideo(stryMutAct_9fa48("50860") ? true : (stryCov_9fa48("50860"), false)))}>
          <div className="relative w-full max-w-4xl" onClick={stryMutAct_9fa48("50861") ? () => undefined : (stryCov_9fa48("50861"), e => e.stopPropagation())}>
            <button onClick={stryMutAct_9fa48("50862") ? () => undefined : (stryCov_9fa48("50862"), () => setShowVideo(stryMutAct_9fa48("50863") ? true : (stryCov_9fa48("50863"), false)))} className="absolute -top-12 right-0 text-white hover:text-amber-500 transition-colors">
              <X size={32} />
            </button>
            <div className="aspect-video bg-slate-900 rounded-xl overflow-hidden border border-white/10">
              {/* Placeholder for video - replace with actual video embed */}
              <div className="w-full h-full flex flex-col items-center justify-center text-center p-8">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">Product Demo</h3>
                <p className="text-slate-400 mb-6">See how Datacendia transforms enterprise decision-making</p>
                <Link to="/demo" className="px-6 py-3 bg-amber-500 text-black font-bold rounded hover:bg-amber-400 transition-colors" onClick={stryMutAct_9fa48("50864") ? () => undefined : (stryCov_9fa48("50864"), () => setShowVideo(stryMutAct_9fa48("50865") ? true : (stryCov_9fa48("50865"), false)))}>
                  Request Live Demo
                </Link>
              </div>
            </div>
