...
export function cx(...classes: (string | undefined | null | false)[]): string {
  return stryMutAct_9fa48("15394") ? classes.join(' ') : (stryCov_9fa48("15394"), classes.filter(Boolean).join(' '));
}
...
export function getSeverityClasses(severity: 'critical' | 'high' | 'medium' | 'low'): string {
  const map = stryMutAct_9fa48("15398") ? {} : (stryCov_9fa48("15398"), {
...
export default stryMutAct_9fa48("15403") ? {} : (stryCov_9fa48("15403"), {
  colors,
  semantic,
  tw,
  presets,
