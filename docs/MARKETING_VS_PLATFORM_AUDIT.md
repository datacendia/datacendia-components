...
Compared to the Feb 18 self-audit score of 8/10, the platform has since improved (DCII dashboard now functional, mojibake fixed, receipt page upgraded), making the marketing site slightly behind on showcasing these improvements. The gap is small and addressable.

---

*Generated by platform comparison audit — Feb 20, 2026*
