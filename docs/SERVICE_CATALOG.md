...
| Agent | Code | Purpose | AI Model | Pillars Used | Industry |
|-------|------|---------|----------|--------------|----------|
| **Chief Strategy Agent** | `chief` | Strategic synthesis & executive coordination | llama3.3:70b | Helm, Predict, Ethics | All |
| **Financial Intelligence (CFO)** | `cfo` | Financial analysis, ROI, cash flow | llama3.3:70b | Helm, Predict, Ledger | Finance, All |
| **Operations Intelligence (COO)** | `coo` | Process efficiency, resource allocation | llama3.2:3b | Flow, Health, Helm | Manufacturing, All |
| **Security & Compliance (CISO)** | `ciso` | Security assessment, compliance | qwq:32b | Guard, Ethics, Health | All |
| **Market Intelligence (CMO)** | `cmo` | Market analysis, customer insights | llama3.3:70b | Predict, Helm, Lineage | Retail, All |
| **Revenue Intelligence (CRO)** | `cro` | Revenue optimization, sales performance | llama3.3:70b | Helm, Predict, Flow | SaaS, All |
| **Data Quality (CDO)** | `cdo` | Data governance, lineage, quality | qwen2.5-coder:32b | Lineage, Health, Guard | All |
| **Risk Assessment** | `risk` | Enterprise risk, scenario planning | qwq:32b | Guard, Predict, Ethics | Finance, All |

## Advanced Council (FREE - Included in Base Platform)

| Agent | Code | Purpose | AI Model | Pillars Used | Industry |
|-------|------|---------|----------|--------------|----------|
| **Legal Intelligence (CLO)** | `clo` | Legal risk, contracts, compliance | qwq:32b | Guard, Ethics, Lineage | Legal, All |
| **Product Strategy (CPO)** | `cpo` | Product roadmap, user research | llama3.3:70b | Predict, Flow, Helm | Tech, All |
| **AI Strategy (CAIO)** | `caio` | AI governance, ethical AI | qwq:32b | Ethics, Agents, Predict | Tech, All |
| **Sustainability (CSO)** | `cso` | ESG, carbon footprint | llama3.3:70b | Ethics, Helm, Health | All |
| **Investment Intelligence (CIO)** | `cio` | Capital allocation, portfolio | llama3.3:70b | Predict, Helm, Guard | Finance |
| **Communications (CCO)** | `cco` | Corporate messaging, PR | llama3.2:3b | Ethics, Helm | All |
...
| Agent | Code | Purpose | Certifications |
|-------|------|---------|----------------|
| Chief Medical Info Officer | `cmio` | Health IT, EHR optimization | HIPAA |
| Patient Safety Officer | `pso` | Clinical safety, adverse events | Joint Commission |
| Healthcare Compliance | `hco` | HIPAA, Stark Law, Anti-Kickback | HIPAA, SOX |
| Clinical Operations Dir | `cod` | Patient flow, staffing | Lean Healthcare |

**Pillars Used:** Health, Guard, Ethics, Flow

## Finance Package ($399/month)

| Agent | Code | Purpose | Certifications |
|-------|------|---------|----------------|
| Quantitative Analyst | `quant` | Financial modeling, derivatives | CFA |
| Portfolio Manager | `pm` | Asset allocation, investment | Series 7 |
| Credit Risk Officer | `cro-finance` | Credit analysis, Basel | Basel III |
| Treasury Analyst | `treasury` | Cash management, FX | CTP |

**Pillars Used:** Helm, Predict, Guard, Lineage

## Legal Package ($399/month)

| Agent | Code | Purpose | Certifications |
|-------|------|---------|----------------|
| Contract Specialist | `contracts` | Contract drafting, negotiation | - |
| IP Counsel | `ip` | Patents, trademarks | USPTO |
| Litigation Specialist | `litigation` | Case strategy, discovery | - |
| Regulatory Affairs | `reg-affairs` | Agency filings, compliance | - |

**Pillars Used:** Guard, Ethics, Lineage
...
|------|-------------|----------|-----------------|
| **Free** | $0 | 14 Core Agents, 8 Pillars, Basic Council | Startups, SMBs |
| **Standard** | $99-199/mo | Export, Analytics, Custom Agents | Growing Teams |
...
# AGENT → PILLAR MAPPING

| Agent | Helm | Lineage | Predict | Flow | Health | Guard | Ethics | Agents |
|-------|:----:|:-------:|:-------:|:----:|:------:|:-----:|:------:|:------:|
| Chief | ✅ | | ✅ | ✅ | | | ✅ | ✅ |
| CFO | ✅ | | ✅ | | | | | |
| COO | | | | ✅ | ✅ | | | |
