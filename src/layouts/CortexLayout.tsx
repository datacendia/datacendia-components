...
const foundationGroup: NavGroup = {
  ...
  items: [
    ...
    },
    {
      ...
      icon: HeartPulse,
      path: '/cortex/pulse',
      tooltip: 'System health & decision monitoring \u2014 real-time alerts',
    },
    {
      id: 'bridge',
      label: 'Bridge',
      icon: Columns,
      path: '/cortex/bridge',
      tooltip: 'Workflow automation, approvals & integrations',
    },
    {
      id: 'graph',
      label: 'Graph',
...
const enterpriseGroup: NavGroup = {
  ...
  items: [
    ...
    },
    {
      ...
      tooltip: 'CendiaLens, Decision DNA, What-If, Orbit, Consensus & more',
    },
    {
      id: 'crown-jewels',
      label: 'Crown Jewels',
...
const strategicGroup: NavGroup = {
  ...
  items: [
    ...
    },
    {
      ...
      icon: Factory,
      path: '/verticals',
      tooltip: '26 industry verticals with full agent packs',
    },
    {
      id: 'frontier',
      label: 'Frontier',
