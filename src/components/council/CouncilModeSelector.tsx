/**
 * Component — Council Mode Selector
 *
 * Reusable React UI component.
 *
 * @exports CouncilModeSelector, CouncilModeBadge, CouncilModeCard, CouncilModeQuickSwitch
 * @module components/council/CouncilModeSelector
 */
