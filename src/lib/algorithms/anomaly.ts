 ...
 *
 * @exports detectAnomaliesZScore, medianAbsoluteDeviation, modifiedZScore, detectAnomaliesModifiedZ, detectOutliersIQR, cusum, detectDrift, earlyWarningScore
 * @module lib/algorithms/anomaly
 */
