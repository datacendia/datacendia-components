/**
 * Library — Use Council Stream
 *
 * Client-side utility library.
 *
 * @exports useCouncilConnection, useDeliberation, useCouncilDeliberation, useAgentStream, UseCouncilStreamOptions, UseDeliberationOptions, DeliberationConfig
 * @module lib/council/useCouncilStream
 */
