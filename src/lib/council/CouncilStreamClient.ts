 ...
 *
 * @exports CouncilStreamClient, getCouncilStreamClient, StreamEvent, DeliberationState, AgentStreamState, ChallengeState
 * @module lib/council/CouncilStreamClient
 */
