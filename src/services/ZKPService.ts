/**
 * Frontend Service — Z K P Service
 *
 * Client-side service for API communication and business logic.
 *
 * @exports ZKPService, ProofTypeInfo, ZKProofRequest, ZKProof, ProofVerificationResult, ComplianceCertificate, ProofType, ProofStatus
