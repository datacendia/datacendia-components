...
class DissentService {
    ...
    return [
      {
        ...
        decisionDate: new Date('2025-12-08'),
        ...
        createdAt: new Date('2025-12-08T14:32:00'),
        updatedAt: new Date('2025-12-08T14:32:00'),
        ledgerHash: 'abc123',
        ledgerTimestamp: new Date('2025-12-08T14:32:00'),
      },
      {
        id: 'dissent-2',
        organizationId: 'demo-org',
      ...
      },
      {
        ...
        outcomeVerified: true,
        dissenterWasRight: true,
        outcomeVerifiedAt: new Date('2025-12-01'),
        createdAt: new Date('2025-09-01'),
        updatedAt: new Date('2025-09-03'),
        ledgerHash: 'mno345',
        ledgerTimestamp: new Date('2025-09-01'),
      },
    ];
  }
  ...
  private getMockMetrics(): OrganizationDissentMetrics {
    return {
      ...
      trend: [
        { date: '2025-06', count: 6, accuracy: 55 },
        { date: '2025-07', count: 8, accuracy: 58 },
        { date: '2025-08', count: 7, accuracy: 62 },
        { date: '2025-09', count: 10, accuracy: 65 },
        { date: '2025-10', count: 9, accuracy: 64 },
        { date: '2025-11', count: 8, accuracy: 68 },
        { date: '2025-12', count: 7, accuracy: 67 },
      ],
    };
  }
