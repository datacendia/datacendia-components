...
export function getMockScore(): ApotheosisScore {
  return {
    ...
    trend: [
      { date: '2025-04', score: 78.2 },
      { date: '2025-06', score: 82.4 },
      { date: '2025-09', score: 88.1 },
      { date: '2025-12', score: 92.3 },
      { date: '2026-02', score: 94.7 },
    ],
    improvementPoints: 16.5,
    improvementPeriod: '10 months',
  };
}
