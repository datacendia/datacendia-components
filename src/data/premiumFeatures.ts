...
> = {
  pilot: {
    ...
    icon: '🌱',
    annualPricing: 'Free',
    tagline: 'Open-source core for individuals and small teams',
    pillarCount: 1,
  },
  foundation: {
    name: 'Foundation',
  ...
  strategic: {
    name: 'Strategic',
    color: '#C9A84C',
    bgGradient: 'from-[#c9a84c] to-[#b8963f]',
    icon: '👑',
    annualPricing: 'Custom',
    tagline: 'Tailored to your organization — contact sales',
    pillarCount: 12,
  },
};
...
export const PREMIUM_BUNDLES: PremiumBundle[] = [
  {
    ...
    annualPricing: '$499/month ($4,990/year)',
  ...
  },
  {
    ...
    annualPricing: '$1,499/month ($14,990/year)',
  ...
  },
  {
    ...
    annualPricing: 'Custom — Contact Sales',
