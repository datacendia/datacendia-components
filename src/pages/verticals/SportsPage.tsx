...
const agents = [
  { code: 'performance', name: 'Performance Director', purpose: 'Team analytics, game strategy, performance optimization', model: 'qwq:32b' },
  { code: 'scouting', name: 'Scouting Director', purpose: 'Player evaluation, draft analysis, talent identification', model: 'llama3.3:70b' },
  { code: 'sports-med', name: 'Sports Medicine', purpose: 'Injury prediction, recovery optimization, load management', model: 'qwq:32b' },
  { code: 'revenue', name: 'Revenue Director', purpose: 'Ticketing, sponsorships, media rights, merchandise', model: 'llama3.3:70b' },
];

const compliance = ['Salary Cap Rules', 'League Regulations', 'Player Union Agreements', 'Broadcasting Rights', 'Anti-Doping', 'Gambling Regulations'];

const pricing = [
  { package: 'Sports Starter', price: '$80,000', includes: '8 Pillars + 4 Sports Agents', roi: '6 months' },
  { package: 'Sports Professional', price: '$600,000', includes: '+ Predict, Crucible, Aegis', roi: '4 months' },
  { package: 'Sports Enterprise', price: '$3,000,000', includes: '+ Full Guardian Suite', roi: '3 months' },
  { package: 'Sports Franchise', price: '$8,000,000+', includes: '+ Multi-team, custom models', roi: '2 months' },
];
          ...
          <div className="space-y-12">
            <section>
              ...
              <div className="grid grid-cols-3 gap-6">
                {[
                  { title: 'Player Analytics', desc: 'AI-powered performance analysis, injury prediction, and load management across your entire roster', icon: '📊' },
                  { title: 'Scouting Intelligence', desc: 'Evaluate 10x more prospects with Council deliberation on draft picks and acquisitions', icon: '🔍' },
                  { title: 'Revenue Optimization', desc: 'Dynamic ticket pricing, sponsorship valuation, and media rights negotiation support', icon: '💰' },
                ].map(item => (
            ...
            <section>
              ...
              <div className="space-y-4">
                {[
                  { org: 'Professional Basketball Team', quote: 'Injury prediction model identified 67% of soft tissue injuries before they occurred. Reduced games lost to injury by 23%.', metric: '67% prediction' },
                  { org: 'MLB Organization', quote: 'Draft analysis improved hit rate on picks by 28%. The Council identified undervalued prospects our scouts missed.', metric: '28% better picks' },
                  { org: 'Sports Entertainment Company', quote: 'Dynamic ticket pricing increased per-game revenue 18% while maintaining 97% attendance.', metric: '18% revenue lift' },
                ].map((cs, idx) => (
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-2">
                {compliance.map(c => (
                  <span key={c} className="px-4 py-2 bg-emerald-500/10 text-emerald-400 rounded-lg border border-emerald-500/30 font-medium">{c}</span>
                ))}
              </div>
            </section>
        ...
        {activeTab === 'agents' && (
          <div className="space-y-12">
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-6">
                {[
                  { name: 'Injury Prediction Engine', use: 'Biomechanical analysis, load monitoring, soft tissue risk scoring' },
                  { name: 'Draft Intelligence', use: 'Prospect evaluation, career trajectory modeling, value-over-replacement' },
                  { name: 'Game Strategy Simulator', use: 'Play-by-play simulation, matchup analysis, situational optimization' },
                  { name: 'Fan Revenue Optimizer', use: 'Dynamic pricing, attendance forecasting, sponsor ROI modeling' },
                ].map(service => (
