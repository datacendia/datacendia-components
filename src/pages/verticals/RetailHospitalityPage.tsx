...
const agents = [
  { code: 'merchandising', name: 'Merchandising Director', purpose: 'Assortment planning, inventory optimization, category management', model: 'llama3.3:70b' },
  { code: 'revenue-mgr', name: 'Revenue Manager', purpose: 'Dynamic pricing, demand forecasting, yield optimization', model: 'qwq:32b' },
  { code: 'store-ops', name: 'Store Operations', purpose: 'Staffing optimization, store performance, operational efficiency', model: 'qwq:32b' },
  { code: 'cx', name: 'Customer Experience', purpose: 'Journey optimization, loyalty strategy, personalization', model: 'llama3.3:70b' },
];

const compliance = ['PCI-DSS', 'GDPR', 'CCPA', 'ADA', 'Labor Laws', 'Food Safety', 'Consumer Protection'];

const pricing = [
  { package: 'Retail Starter', price: '$60,000', includes: '8 Pillars + 4 Retail Agents', roi: '8 months' },
  { package: 'Retail Professional', price: '$400,000', includes: '+ Panopticon, Predict, Mesh', roi: '5 months' },
  { package: 'Retail Enterprise', price: '$2,500,000', includes: '+ Full Guardian Suite', roi: '3 months' },
  { package: 'Retail Sovereign', price: '$6,000,000+', includes: '+ Multi-brand, custom', roi: '2 months' },
];
      ...
      <div className="relative overflow-hidden border-b border-neutral-800">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-4 gap-6 mt-12">
            {[
              { label: '18-Month ROI', value: '19%', subtext: 'margin improvement' },
              { label: 'Pricing Velocity', value: '10x', subtext: 'faster updates' },
              { label: 'RevPAR Lift', value: '12%', subtext: 'hospitality avg' },
              { label: 'Markdown Waste', value: '-25%', subtext: 'reduction' },
            ].map(stat => (
          ...
          <div className="space-y-12">
            <section>
              ...
              <div className="grid grid-cols-3 gap-6">
                {[
                  { title: 'Dynamic Pricing', desc: 'AI-powered pricing decisions that respond to demand signals in real-time with full audit trail', icon: '💰' },
                  { title: 'Demand Sensing', desc: 'Predict demand shifts before they happen with multi-signal analysis', icon: '📊' },
                  { title: 'Markdown Optimization', desc: 'Reduce markdown waste by 25% with AI-optimized clearance strategies', icon: '🏷️' },
                ].map(item => (
            ...
            <section>
              ...
              <div className="space-y-4">
                {[
                  { org: 'Regional Retailer (200 stores)', quote: 'Gross margin improved 19% with dynamic pricing. The Council identified pricing opportunities we were leaving on the table.', metric: '19% margin' },
                  { org: 'Hotel Chain (50 properties)', quote: 'RevPAR increased 12% with AI-optimized rate management. We can now adjust pricing 10x faster than competitors.', metric: '12% RevPAR' },
                  { org: 'Quick Service Restaurant', quote: 'Menu pricing decisions backed by data instead of gut feel. Reduced customer complaints about price increases by 40%.', metric: '40% fewer complaints' },
                ].map((cs, idx) => (
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-2">
                {compliance.map(c => (
                  <span key={c} className="px-4 py-2 bg-rose-500/10 text-rose-400 rounded-lg border border-rose-500/30 font-medium">{c}</span>
                ))}
              </div>
            </section>
          </div>
