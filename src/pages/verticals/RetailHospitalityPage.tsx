/**
 * Page — Retail Hospitality Page
 *
 * React page component rendered by the router.
 *
 * @exports RetailHospitalityPage
 * @module pages/verticals/RetailHospitalityPage
 */
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-4">
                <button
                  onClick={() => navigate('/cortex/council?vertical=retail')}
                ...
                >
                  <span>🏛️</span> Launch Retail Council
                </button>
              </div>
            </div>
                ...
                {[
                  {
                    ...
                    quote:
                      'Gross margin improved 19% with dynamic pricing. The Council identified pricing opportunities we were leaving on the table.',
                    metric: '19% margin',
                  },
                  {
                    org: 'Hotel Chain (50 properties)',
                    quote:
                      'RevPAR increased 12% with AI-optimized rate management. We can now adjust pricing 10x faster than competitors.',
                    metric: '12% RevPAR',
                  },
                  {
                    org: 'Quick Service Restaurant',
                    quote:
                      'Menu pricing decisions backed by data instead of gut feel. Reduced customer complaints about price increases by 40%.',
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-2">
                {compliance.map((c) => (
                  <span
                    key={c}
                    className="px-4 py-2 bg-rose-500/10 text-rose-400 rounded-lg border border-rose-500/30 font-medium"
                  >
                    {c}
                  </span>
                ))}
