...
const agents = [
  { code: 'enrollment', name: 'Enrollment Director', purpose: 'Admissions strategy, yield optimization, scholarship allocation', model: 'qwq:32b' },
  { code: 'provost', name: 'Academic Affairs', purpose: 'Curriculum decisions, faculty hiring, program assessment', model: 'llama3.3:70b' },
  { code: 'research', name: 'Research Director', purpose: 'Grant strategy, research portfolio, partnership evaluation', model: 'qwq:32b' },
  { code: 'finance-edu', name: 'CFO/Finance', purpose: 'Budget planning, endowment strategy, tuition modeling', model: 'llama3.3:70b' },
];

const compliance = ['FERPA', 'Title IX', 'ADA', 'Accreditation Standards', 'NCAA', 'Research Ethics (IRB)', 'Federal Financial Aid'];

const pricing = [
  { package: 'Education Starter', price: '$60,000', includes: '8 Pillars + 4 Education Agents', roi: '8 months' },
  { package: 'Education Professional', price: '$400,000', includes: '+ Predict, Eternal, Panopticon', roi: '5 months' },
  { package: 'Education Enterprise', price: '$2,000,000', includes: '+ Full Guardian Suite', roi: '3 months' },
  { package: 'Education Sovereign', price: '$5,000,000+', includes: '+ University system, custom', roi: '2 months' },
];
          ...
          <div className="space-y-12">
            <section>
              ...
              <div className="grid grid-cols-3 gap-6">
                {[
                  { title: 'Enrollment Intelligence', desc: 'AI-powered yield optimization, scholarship allocation, and applicant scoring with full FERPA compliance', icon: '📊' },
                  { title: 'Research Portfolio', desc: 'Grant opportunity matching, collaboration recommendations, and research impact prediction', icon: '🔬' },
                  { title: 'Institutional Planning', desc: 'Program viability analysis, budget scenario modeling, and strategic resource allocation', icon: '🏛️' },
                ].map(item => (
            ...
            <section>
              ...
              <div className="space-y-4">
                {[
                  { org: 'Regional University', quote: 'Enrollment yield improved 23% by optimizing scholarship offers and applicant communications. Net tuition revenue up $4.2M.', metric: '23% yield' },
                  { org: 'Research University', quote: 'Grant application success rate increased 35% by matching researchers to the right opportunities.', metric: '35% grant success' },
                  { org: 'Community College System', quote: 'Student retention improved 8% through early warning system that identified at-risk students 6 weeks earlier.', metric: '8% retention' },
                ].map((cs, idx) => (
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-2">
                {compliance.map(c => (
                  <span key={c} className="px-4 py-2 bg-violet-500/10 text-violet-400 rounded-lg border border-violet-500/30 font-medium">{c}</span>
                ))}
              </div>
            </section>
          </div>
