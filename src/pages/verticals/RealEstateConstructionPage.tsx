...
const agents = [
  { code: 'development', name: 'Development Director', purpose: 'Site selection, feasibility analysis, project approval', model: 'qwq:32b' },
  { code: 'construction', name: 'Construction Manager', purpose: 'Project scheduling, contractor management, cost control', model: 'llama3.3:70b' },
  { code: 'investment', name: 'Investment Analyst', purpose: 'Deal evaluation, cap rate analysis, portfolio optimization', model: 'qwq:32b' },
  { code: 'property', name: 'Property Manager', purpose: 'Lease optimization, tenant relations, maintenance planning', model: 'llama3.3:70b' },
];

const compliance = ['Zoning Laws', 'Building Codes', 'Environmental (NEPA)', 'ADA', 'OSHA', 'Fair Housing', 'Contractor Licensing'];

const pricing = [
  { package: 'Real Estate Starter', price: '$80,000', includes: '8 Pillars + 4 RE Agents', roi: '8 months' },
  { package: 'Real Estate Professional', price: '$500,000', includes: '+ Predict, Crucible, Panopticon', roi: '5 months' },
  { package: 'Real Estate Enterprise', price: '$2,500,000', includes: '+ Full Guardian Suite', roi: '3 months' },
  { package: 'Real Estate Sovereign', price: '$6,000,000+', includes: '+ Multi-portfolio, custom', roi: '2 months' },
];
          ...
          <div className="space-y-12">
            <section>
              ...
              <div className="grid grid-cols-3 gap-6">
                {[
                  { title: 'Deal Intelligence', desc: 'AI-powered feasibility analysis reviewing market data, comps, and risk factors for faster go/no-go decisions', icon: '📊' },
                  { title: 'Construction Optimization', desc: 'Project scheduling with AI-predicted delays, change order reduction, and contractor performance tracking', icon: '🏗️' },
                  { title: 'Portfolio Analytics', desc: 'Real-time asset performance monitoring with disposition and refinance recommendations', icon: '🏢' },
                ].map(item => (
            ...
            <section>
              ...
              <div className="space-y-4">
                {[
                  { org: 'Regional Developer', quote: 'Project cost overruns reduced 22% through AI-predicted change order prevention. Council identified design conflicts before construction.', metric: '22% cost savings' },
                  { org: 'REIT ($2B AUM)', quote: 'Deal analysis time cut from 3 weeks to 3 days. We now review 5x more opportunities with better data.', metric: '5x deal velocity' },
                  { org: 'General Contractor', quote: 'Schedule delays reduced 40% by predicting weather, labor, and supply chain impacts 60 days out.', metric: '40% fewer delays' },
                ].map((cs, idx) => (
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-2">
                {compliance.map(c => (
                  <span key={c} className="px-4 py-2 bg-stone-500/10 text-stone-400 rounded-lg border border-stone-500/30 font-medium">{c}</span>
                ))}
              </div>
            </section>
          </div>
