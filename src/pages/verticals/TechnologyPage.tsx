...
const agents = [
  { code: 'product', name: 'Product Director', purpose: 'Roadmap prioritization, feature decisions, market analysis', model: 'llama3.3:70b' },
  { code: 'engineering', name: 'Engineering Lead', purpose: 'Technical architecture, build vs buy, tech debt decisions', model: 'qwq:32b' },
  { code: 'security-arch', name: 'Security Architect', purpose: 'Security design, threat modeling, compliance alignment', model: 'qwq:32b' },
  { code: 'growth', name: 'Growth Strategist', purpose: 'GTM strategy, pricing decisions, expansion planning', model: 'llama3.3:70b' },
];

const compliance = ['SOC 2', 'ISO 27001', 'GDPR', 'CCPA', 'HIPAA BAA', 'FedRAMP', 'PCI-DSS'];

const pricing = [
  { package: 'Tech Starter', price: '$60,000', includes: '8 Pillars + 4 Tech Agents', roi: '6 months' },
  { package: 'Tech Professional', price: '$400,000', includes: '+ Panopticon, Aegis, Genomics', roi: '4 months' },
  { package: 'Tech Enterprise', price: '$2,000,000', includes: '+ Full Guardian Suite', roi: '3 months' },
  { package: 'Tech Sovereign', price: '$5,000,000+', includes: '+ Self-hosted, custom', roi: '2 months' },
];
          ...
          <div className="space-y-12">
            <section>
              ...
              <div className="grid grid-cols-3 gap-6">
                {[
                  { title: 'Ship Faster', desc: 'AI-powered product decisions with full audit trail for board and investors', icon: '🚀' },
                  { title: 'AI Governance', desc: 'Document AI decisions before regulators ask. EU AI Act compliant from day one.', icon: '📋' },
                  { title: 'Build vs Buy Clarity', desc: 'Multi-agent deliberation on technical architecture decisions with cost modeling', icon: '⚖️' },
                ].map(item => (
            ...
            <section>
              ...
              <div className="space-y-4">
                {[
                  { org: 'Series B SaaS ($20M ARR)', quote: 'Release velocity improved 41%. The Council helped us say no to 60% of feature requests with data-backed reasoning.', metric: '41% faster' },
                  { org: 'Enterprise Software Company', quote: 'Build vs buy decisions that paralyzed us for months now happen in days. Saved $2M on a wrong vendor choice we almost made.', metric: '$2M saved' },
                  { org: 'AI Startup', quote: 'Our AI governance documentation went from "we should do that" to "done" overnight. Critical for enterprise sales.', metric: 'Enterprise ready' },
                ].map((cs, idx) => (
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-2">
                {compliance.map(c => (
                  <span key={c} className="px-4 py-2 bg-cyan-500/10 text-cyan-400 rounded-lg border border-cyan-500/30 font-medium">{c}</span>
                ))}
              </div>
            </section>
          </div>
