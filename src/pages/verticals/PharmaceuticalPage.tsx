...
const agents = [
  { code: 'cso', name: 'Chief Scientific Officer', purpose: 'R&D strategy, pipeline prioritization, scientific advisory', model: 'llama3.3:70b' },
  { code: 'regulatory', name: 'Regulatory Affairs', purpose: 'FDA submissions, global filing strategy, compliance tracking', model: 'qwq:32b' },
  { code: 'clinical-ops', name: 'Clinical Operations', purpose: 'Trial design, site selection, enrollment optimization', model: 'qwq:32b' },
  { code: 'medical-affairs', name: 'Medical Affairs', purpose: 'KOL engagement, medical education, publication strategy', model: 'llama3.3:70b' },
];

const compliance = ['21 CFR Part 11', 'FDA AI Guidance', 'GxP', 'ICH Guidelines', 'EMA Requirements', 'HIPAA', 'Clinical Trial Regulations', 'Pharmacovigilance'];

const pricing = [
  { package: 'Pharma Starter', price: '$150,000', includes: '8 Pillars + 4 Pharma Agents', roi: '8 months' },
  { package: 'Pharma Professional', price: '$1,500,000', includes: '+ Panopticon, Crucible, Eternal', roi: '5 months' },
  { package: 'Pharma Enterprise', price: '$6,000,000', includes: '+ Full Guardian Suite', roi: '3 months' },
  { package: 'Pharma Sovereign', price: '$15,000,000+', includes: '+ Global, air-gapped, custom', roi: '2 months' },
];
          ...
          <div className="space-y-12">
            <section>
              ...
              <div className="grid grid-cols-3 gap-6">
                {[
                  { title: '21 CFR Part 11 Compliant', desc: 'Full electronic record and signature compliance with automated audit trail generation', icon: '📋' },
                  { title: 'FDA AI Guidance Ready', desc: 'Documentation and validation framework aligned with emerging FDA AI/ML guidance', icon: '🏛️' },
                  { title: 'Pipeline Intelligence', desc: 'AI-powered go/no-go decisions with Council deliberation on $4M+/month decisions', icon: '🧬' },
                ].map(item => (
            ...
            <section>
              ...
              <div className="space-y-4">
                {[
                  { org: 'Mid-Size Biotech', quote: 'Phase II go/no-go decisions that took 6 weeks now happen in 4 weeks with complete documentation for investors.', metric: '31% faster' },
                  { org: 'Global Pharma Company', quote: 'Regulatory submission prep time cut by 40%. The Council identified 23 documentation gaps before FDA review.', metric: '40% faster prep' },
                  { org: 'CRO Partner', quote: 'Site selection decisions improved by analyzing 10x more data points than our previous process.', metric: '10x more data' },
                ].map((cs, idx) => (
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-2">
                {compliance.map(c => (
                  <span key={c} className="px-4 py-2 bg-pink-500/10 text-pink-400 rounded-lg border border-pink-500/30 font-medium">{c}</span>
                ))}
              </div>
            </section>
          </div>
