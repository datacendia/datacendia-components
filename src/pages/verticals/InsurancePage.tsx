...
const agents = [
  { code: 'actuary', name: 'Chief Actuary', purpose: 'Risk modeling, pricing optimization, reserve analysis', model: 'qwq:32b' },
  { code: 'underwriting', name: 'Underwriting Manager', purpose: 'Risk selection, policy structuring, capacity allocation', model: 'llama3.3:70b' },
  { code: 'claims', name: 'Claims Director', purpose: 'Claims triage, fraud detection, settlement optimization', model: 'qwq:32b' },
  { code: 'risk-ins', name: 'Risk Manager', purpose: 'Portfolio analysis, catastrophe modeling, reinsurance strategy', model: 'llama3.3:70b' },
];

const compliance = ['State Insurance Laws', 'NAIC Model Laws', 'Solvency II', 'GDPR', 'CCPA', 'ORSA', 'RBC Requirements', 'Market Conduct'];

const pricing = [
  { package: 'Insurance Starter', price: '$100,000', includes: '8 Pillars + 4 Insurance Agents', roi: '8 months' },
  { package: 'Insurance Professional', price: '$1,000,000', includes: '+ Panopticon, Crucible, Aegis', roi: '5 months' },
  { package: 'Insurance Enterprise', price: '$4,000,000', includes: '+ Full Guardian Suite', roi: '3 months' },
  { package: 'Insurance Sovereign', price: '$10,000,000+', includes: '+ Multi-state, custom models', roi: '2 months' },
];
          ...
          <div className="space-y-12">
            <section>
              ...
              <div className="grid grid-cols-3 gap-6">
                {[
                  { title: 'Multi-State Compliance', desc: 'Navigate 50+ regulatory jurisdictions with automated compliance monitoring and filing tracking', icon: '📋' },
                  { title: 'Real-Time Loss Ratio', desc: 'Continuous monitoring with AI-powered early warning for adverse development', icon: '📊' },
                  { title: 'Claims Fraud Detection', desc: 'Pattern recognition across claims history identifies fraud 3.2x better than rules-based systems', icon: '🔍' },
                ].map(item => (
            ...
            <section>
              ...
              <div className="space-y-4">
                {[
                  { org: 'P&C Carrier ($2B premium)', quote: 'Loss ratio improved 29% in first year. The Council identified underwriting blind spots we\'d missed for years.', metric: '29% loss ratio' },
                  { org: 'Life Insurance Company', quote: 'Underwriting decisions that took 2 weeks now happen in 2 days with full audit trail for regulators.', metric: '2wk → 2d' },
                  { org: 'Claims Administrator', quote: 'Fraud detection rate increased 3.2x while reducing false positives by 40%.', metric: '3.2x fraud detection' },
                ].map((cs, idx) => (
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-2">
                {compliance.map(c => (
                  <span key={c} className="px-4 py-2 bg-orange-500/10 text-orange-400 rounded-lg border border-orange-500/30 font-medium">{c}</span>
                ))}
              </div>
            </section>
          </div>
