...
const agents = [
  { code: 'partner', name: 'Managing Partner', purpose: 'Practice strategy, client portfolio, partner decisions', model: 'llama3.3:70b' },
  { code: 'engagement', name: 'Engagement Manager', purpose: 'Project staffing, utilization, delivery optimization', model: 'qwq:32b' },
  { code: 'bd', name: 'Business Development', purpose: 'Pipeline management, proposal strategy, client expansion', model: 'llama3.3:70b' },
  { code: 'quality', name: 'Quality & Risk', purpose: 'Engagement risk, independence, professional standards', model: 'qwq:32b' },
];

const compliance = ['AICPA Standards', 'SEC Independence', 'PCAOB', 'State Bar Rules', 'Consulting Ethics', 'Client Confidentiality', 'SOX'];

const pricing = [
  { package: 'Services Starter', price: '$60,000', includes: '8 Pillars + 4 Services Agents', roi: '6 months' },
  { package: 'Services Professional', price: '$400,000', includes: '+ Predict, Eternal, Panopticon', roi: '4 months' },
  { package: 'Services Enterprise', price: '$2,000,000', includes: '+ Full Guardian Suite', roi: '3 months' },
  { package: 'Services Sovereign', price: '$5,000,000+', includes: '+ Multi-practice, custom', roi: '2 months' },
];
          ...
          <div className="space-y-12">
            <section>
              ...
              <div className="grid grid-cols-3 gap-6">
                {[
                  { title: 'Staffing Optimization', desc: 'AI-powered resource allocation matching skills, availability, and development goals to client needs', icon: '👥' },
                  { title: 'Knowledge Intelligence', desc: 'Institutional knowledge capture and retrieval - find relevant work product 4x faster', icon: '🧠' },
                  { title: 'Client Development', desc: 'Pipeline prioritization, proposal strategy, and cross-selling recommendations with audit trail', icon: '📈' },
                ].map(item => (
            ...
            <section>
              ...
              <div className="space-y-4">
                {[
                  { org: 'Regional CPA Firm', quote: 'Staff utilization improved 31% through AI-optimized scheduling. We reduced unbilled time by 45% in busy season.', metric: '31% utilization' },
                  { org: 'Management Consultancy', quote: 'Proposal win rate increased 18% by matching the right team to each opportunity. The Council sees patterns our partners miss.', metric: '18% win rate' },
                  { org: 'Law Firm (200 attorneys)', quote: 'Associates find relevant precedents 4x faster. Knowledge that used to retire with partners is now institutional.', metric: '4x faster research' },
                ].map((cs, idx) => (
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-2">
                {compliance.map(c => (
                  <span key={c} className="px-4 py-2 bg-indigo-500/10 text-indigo-400 rounded-lg border border-indigo-500/30 font-medium">{c}</span>
                ))}
              </div>
            </section>
          </div>
