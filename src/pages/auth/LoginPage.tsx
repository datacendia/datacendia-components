          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="flex items-center justify-center gap-2 h-11 px-3 bg-sovereign-card border border-sovereign-border rounded-lg hover:bg-sovereign-hover hover:border-cyan-500/50 transition-colors"
              >
              ...
              <button
                onClick={() => handleEnterpriseSSO('oidc')}
                className="flex items-center justify-center gap-2 h-11 px-3 bg-sovereign-card border border-sovereign-border rounded-lg hover:bg-sovereign-hover hover:border-cyan-500/50 transition-colors"
              >
                <span className="text-lg">🔑</span>
                <div className="text-left">
              ...
              <button
                onClick={() => handleEnterpriseSSO('cert')}
                className="flex items-center justify-center gap-2 h-11 px-3 bg-sovereign-card border border-sovereign-border rounded-lg hover:bg-sovereign-hover hover:border-cyan-500/50 transition-colors"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {error && (
              <div
                ...
                className="p-3 bg-crimson-900/20 border border-crimson-800/50 rounded-lg text-sm text-crimson-400"
              >
                {error}
              </div>
            )}
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full h-11 px-4 bg-sovereign-card border border-sovereign-border rounded-lg text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500"
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded border-gray-600 bg-sovereign-card text-cyan-500 focus:ring-cyan-500"
                />
            ...
            <button
              ...
              disabled={isLoading}
              className={cn(
                'w-full h-11 bg-cyan-600 text-white font-medium rounded-lg',
