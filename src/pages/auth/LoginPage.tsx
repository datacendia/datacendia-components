      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {error && (
              <div data-testid="error-message" className="p-3 bg-error-light border border-error-main rounded-lg text-sm text-error-dark">
                {error}
              </div>
            )}
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full h-11 px-4 border border-neutral-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
