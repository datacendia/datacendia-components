  ...
  const packages = [
    {
      ...
      includes: [
        { item: 'Foundation Plan (1 year)', value: 48000 },
        { item: 'Quick Start Implementation', value: 15000 },
        { item: 'Admin Training', value: 2500 },
      ],
      popular: false,
    },
    {
      ...
      includes: [
        { item: 'Intelligence Plan (1 year)', value: 96000 },
        { item: 'Standard Implementation', value: 35000 },
        { item: 'Power User Bootcamp', value: 4000 },
        { item: 'Priority Support (1 year)', value: 30000 },
      ],
      popular: true,
    },
    {
      ...
      includes: [
        { item: 'Sovereign Plan (1 year)', value: 240000 },
        { item: 'Enterprise Deployment', value: 75000 },
        { item: 'Custom Training Program', value: 8000 },
        { item: 'Premium Support (1 year)', value: 60000 },
        { item: 'Executive Advisory (1 year)', value: 60000 },
      ],
      popular: false,
    },
  ];
