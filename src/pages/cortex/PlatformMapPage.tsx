...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { name: 'CendiaRegulatory™', route: '/cortex/intelligence/regulatory', tier: 'enterprise' },
      { name: 'Decision DNA', route: '/cortex/intelligence/decision-dna', tier: 'enterprise' },
      { name: 'CendiaLens™', route: '/cortex/intelligence/lens', tier: 'enterprise' },
      { name: 'CendiaOrbit™', route: '/cortex/intelligence/orbit', tier: 'enterprise' },
      { name: 'Consensus Builder', route: '/cortex/intelligence/consensus', tier: 'enterprise' },
      { name: 'What-If Scenarios', route: '/cortex/intelligence/what-if', tier: 'enterprise' },
      { name: 'Synthesis Engine', route: '/cortex/intelligence/synthesis', tier: 'enterprise' },
      { name: 'RDP Service', route: '/cortex/intelligence/rdp', tier: 'enterprise' },
      { name: 'CendiaProvenance™', route: '/cortex/intelligence/audit-provenance', tier: 'enterprise' },
    ],
  },
  {
    id: 'gateway',
  ...
  },
  {
    ...
    pages: [
      ...
      { name: 'CendiaCompliance™', route: '/cortex/compliance/continuous-monitor', tier: 'enterprise' },
      { name: 'CendiaGapScan™', route: '/cortex/compliance/gap-scanner', tier: 'enterprise' },
      { name: 'CendiaJurisdiction™', route: '/cortex/compliance/cross-jurisdiction', tier: 'enterprise' },
      { name: 'CendiaSandbox™', route: '/cortex/compliance/regulatory-sandbox', tier: 'enterprise' },
      { name: "Regulator's Receipt", route: '/cortex/compliance/regulators-receipt', tier: 'enterprise' },
    ],
  },
  {
    id: 'governance',
    ...
    color: 'text-cyan-400',
    pages: [
      { name: 'Decision Packets™', route: '/cortex/governance/decision-packets', tier: 'enterprise' },
      { name: 'CendiaCourt™', route: '/cortex/governance/constitutional-court', tier: 'enterprise' },
    ],
  },
  {
    id: 'crypto',
    ...
    color: 'text-amber-400',
    pages: [
      { name: 'CendiaEscrow™', route: '/cortex/crypto/escrow', tier: 'enterprise' },
    ],
  },
  {
    id: 'security',
    ...
    pages: [
      ...
      { name: 'CendiaZKP™', route: '/cortex/security/zkp', tier: 'enterprise' },
    ],
  },
  {
    id: 'crown',
    ...
    pages: [
      { name: 'CendiaEcho™', route: '/cortex/crown/echo', tier: 'enterprise' },
      { name: 'CendiaRedTeam™', route: '/cortex/crown/redteam', tier: 'enterprise' },
      { name: 'CendiaGnosis™', route: '/cortex/crown/gnosis', tier: 'enterprise' },
    ],
  },
  {
    id: 'sovereign',
    ...
    pages: [
      { name: 'Crucible', route: '/cortex/sovereign/crucible', tier: 'enterprise' },
      { name: 'Panopticon', route: '/cortex/sovereign/panopticon', tier: 'enterprise' },
      { name: 'Aegis', route: '/cortex/sovereign/aegis', tier: 'enterprise' },
      { name: 'Eternal', route: '/cortex/sovereign/eternal', tier: 'enterprise' },
      { name: 'ShadowOps', route: '/cortex/sovereign/shadow-ops', tier: 'enterprise' },
      { name: 'Succession', route: '/cortex/sovereign/succession', tier: 'enterprise' },
      { name: 'Sanctuary', route: '/cortex/sovereign/sanctuary', tier: 'enterprise' },
      { name: 'CendiaNotary™', route: '/cortex/sovereign/notary', tier: 'enterprise' },
      { name: 'CendiaVault™', route: '/cortex/sovereign/vault', tier: 'enterprise' },
      { name: 'Symbiont', route: '/cortex/sovereign/symbiont', tier: 'enterprise' },
      { name: 'Vox', route: '/cortex/sovereign/vox', tier: 'enterprise' },
      { name: 'Horizon', route: '/cortex/sovereign/horizon', tier: 'enterprise' },
      { name: 'Defense', route: '/cortex/sovereign/defense', tier: 'enterprise' },
      { name: 'SGAS', route: '/cortex/sovereign/sgas', tier: 'strategic' },
      { name: 'SCGE', route: '/cortex/sovereign/scge', tier: 'strategic' },
      { name: 'COLLAPSE', route: '/cortex/sovereign/collapse', tier: 'strategic' },
    ],
  },
  {
    id: 'monitor',
    ...
    color: 'text-blue-400',
    pages: [
      { name: 'CendiaPulse™ Live', route: '/cortex/monitor/live', tier: 'enterprise' },
    ],
  },
  {
    id: 'settings',
  ...
  },
  {
    ...
    pages: [
      ...
      { name: 'Healthcare', route: '/verticals/healthcare', tier: 'strategic' },
      { name: 'Financial Services', route: '/verticals/financial-services', tier: 'strategic' },
      { name: 'Government & Legal', route: '/verticals/government-legal', tier: 'strategic' },
      { name: 'Legal / Law Firms', route: '/verticals/legal', tier: 'strategic' },
      { name: 'Insurance', route: '/verticals/insurance', tier: 'strategic' },
      { name: 'Pharmaceutical', route: '/verticals/pharmaceutical', tier: 'strategic' },
      { name: 'Manufacturing', route: '/verticals/manufacturing', tier: 'strategic' },
      { name: 'Energy & Utilities', route: '/verticals/energy-utilities', tier: 'strategic' },
      { name: 'Technology / SaaS', route: '/verticals/technology', tier: 'strategic' },
      { name: 'Retail & Hospitality', route: '/verticals/retail-hospitality', tier: 'strategic' },
      { name: 'Real Estate', route: '/verticals/real-estate', tier: 'strategic' },
      { name: 'Transportation', route: '/verticals/transportation', tier: 'strategic' },
      { name: 'Media / Entertainment', route: '/verticals/media-entertainment', tier: 'strategic' },
      { name: 'Professional Services', route: '/verticals/professional-services', tier: 'strategic' },
      { name: 'Higher Education', route: '/verticals/higher-education', tier: 'strategic' },
      { name: 'Sports / Athletics', route: '/verticals/sports', tier: 'strategic' },
      { name: 'Telecommunications', route: '/verticals/telecommunications', tier: 'strategic' },
      { name: 'Aerospace / Defense', route: '/verticals/aerospace', tier: 'strategic' },
      { name: 'Agriculture / AgTech', route: '/verticals/agriculture', tier: 'strategic' },
      { name: 'Automotive', route: '/verticals/automotive', tier: 'strategic' },
      { name: 'Construction', route: '/verticals/construction', tier: 'strategic' },
      { name: 'Hospitality / Travel', route: '/verticals/hospitality', tier: 'strategic' },
      { name: 'Non-Profit / NGO', route: '/verticals/nonprofit', tier: 'strategic' },
      { name: 'Industrial Services', route: '/verticals/industrial-services', tier: 'strategic' },
      { name: 'CendiaCity™ (Smart City)', route: '/verticals/smart-city', tier: 'strategic' },
      { name: 'EU Banking', route: '/verticals/eu-banking', tier: 'strategic' },
    ],
  },
];
    ...
    <div className="p-4 lg:p-6 max-w-[1400px] mx-auto space-y-6">
      ...
      <div className="rounded-xl border border-neutral-700/50 bg-neutral-900/50 p-4">
        ...
        <div className="grid grid-cols-3 md:grid-cols-6 gap-3 text-center">
          {[
            { label: 'Pages', count: 203, color: 'text-blue-400' },
            { label: 'Components', count: 91, color: 'text-purple-400' },
            ...
            { label: 'Total .tsx', count: 318, color: 'text-white' },
          ].map(s => (
            <div key={s.label}>
