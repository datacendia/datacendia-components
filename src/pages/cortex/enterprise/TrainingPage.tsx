...
const mockCourses: Course[] = [
  // Onboarding
  { id: 'C001', title: 'Datacendia Platform Fundamentals', description: 'Core platform concepts and navigation', category: 'onboarding', duration: '45 min', modules: 5, completedModules: 5, status: 'completed', required: true, completedDate: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000), score: 92, passingScore: 80 },
  { id: 'C002', title: 'Council of Agents Overview', description: 'How AI deliberation works', category: 'onboarding', duration: '30 min', modules: 4, completedModules: 4, status: 'completed', required: true, completedDate: new Date(Date.now() - 6 * 24 * 60 * 60 * 1000), score: 88, passingScore: 80 },
  { id: 'C003', title: 'Data Integration Basics', description: 'Connecting data sources', category: 'onboarding', duration: '60 min', modules: 6, completedModules: 3, status: 'in-progress', required: true, dueDate: new Date(Date.now() + 3 * 24 * 60 * 60 * 1000), passingScore: 80 },
  
  // Security
  { id: 'C004', title: 'Security Awareness Training', description: 'Annual security best practices', category: 'security', duration: '45 min', modules: 5, completedModules: 5, status: 'completed', required: true, completedDate: new Date(Date.now() - 30 * 24 * 60 * 60 * 1000), score: 95, passingScore: 85 },
  { id: 'C005', title: 'Phishing Prevention', description: 'Identify and report phishing attempts', category: 'security', duration: '20 min', modules: 3, completedModules: 0, status: 'not-started', required: true, dueDate: new Date(Date.now() + 14 * 24 * 60 * 60 * 1000), passingScore: 90 },
  
  // Compliance
  { id: 'C006', title: 'GDPR Fundamentals', description: 'Data privacy requirements', category: 'compliance', duration: '60 min', modules: 8, completedModules: 8, status: 'completed', required: true, completedDate: new Date(Date.now() - 60 * 24 * 60 * 60 * 1000), score: 90, passingScore: 85 },
  { id: 'C007', title: 'SOC 2 Controls Overview', description: 'Understanding TSC requirements', category: 'compliance', duration: '90 min', modules: 10, completedModules: 0, status: 'not-started', required: false, passingScore: 80 },
  
  // Product
  { id: 'C008', title: 'Advanced Deliberation Techniques', description: 'Power user features', category: 'product', duration: '45 min', modules: 5, completedModules: 2, status: 'in-progress', required: false, passingScore: 75 },
  { id: 'C009', title: 'Chronos Time Machine Deep Dive', description: 'Historical analysis and simulation', category: 'product', duration: '60 min', modules: 6, completedModules: 0, status: 'not-started', required: false, passingScore: 75 },
  
  // Role-specific
  { id: 'C010', title: 'Analyst Certification Program', description: 'Advanced analytics and reporting', category: 'role-specific', duration: '3 hr', modules: 12, completedModules: 0, status: 'not-started', required: false, passingScore: 85 },
  { id: 'C011', title: 'Admin Console Mastery', description: 'Platform administration', category: 'role-specific', duration: '2 hr', modules: 8, completedModules: 4, status: 'in-progress', required: true, dueDate: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000), passingScore: 85 },
];

const mockCertifications: Certification[] = [
  { id: 'CERT001', name: 'Datacendia Certified User', issuer: 'Datacendia', earnedDate: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000), expiryDate: new Date(Date.now() + 358 * 24 * 60 * 60 * 1000), status: 'valid', courses: ['C001', 'C002'] },
  { id: 'CERT002', name: 'Security Awareness Certified', issuer: 'Datacendia', earnedDate: new Date(Date.now() - 30 * 24 * 60 * 60 * 1000), expiryDate: new Date(Date.now() + 335 * 24 * 60 * 60 * 1000), status: 'valid', courses: ['C004'] },
  { id: 'CERT003', name: 'GDPR Compliance Certified', issuer: 'Datacendia', earnedDate: new Date(Date.now() - 60 * 24 * 60 * 60 * 1000), expiryDate: new Date(Date.now() + 25 * 24 * 60 * 60 * 1000), status: 'expiring-soon', courses: ['C006'] },
  { id: 'CERT004', name: 'Datacendia Admin Certified', issuer: 'Datacendia', status: 'not-certified', courses: ['C011'] },
];

const mockLearningPaths: LearningPath[] = [
  { id: 'LP001', name: 'New Employee Onboarding', description: 'Essential training for all new hires', role: 'All', courses: ['C001', 'C002', 'C003', 'C004'], progress: 75, totalHours: 3, completedHours: 2.25 },
  { id: 'LP002', name: 'Security & Compliance Track', description: 'Required security and compliance training', role: 'All', courses: ['C004', 'C005', 'C006'], progress: 66, totalHours: 2, completedHours: 1.75 },
  { id: 'LP003', name: 'Platform Admin Path', description: 'For administrators and power users', role: 'Admin', courses: ['C001', 'C002', 'C008', 'C011'], progress: 50, totalHours: 4, completedHours: 2 },
  { id: 'LP004', name: 'Analyst Certification Path', description: 'Advanced analytics training', role: 'Analyst', courses: ['C001', 'C002', 'C008', 'C009', 'C010'], progress: 25, totalHours: 6, completedHours: 1.5 },
];

const mockTeamMembers: TeamMember[] = [
  { id: 'U001', name: 'Alex Johnson', role: 'Analyst', department: 'Finance', completedCourses: 8, totalRequired: 10, overdueCourses: 0, lastActivity: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000) },
  { id: 'U002', name: 'Sarah Williams', role: 'Manager', department: 'Operations', completedCourses: 12, totalRequired: 12, overdueCourses: 0, lastActivity: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000) },
  { id: 'U003', name: 'Mike Chen', role: 'Analyst', department: 'Finance', completedCourses: 5, totalRequired: 10, overdueCourses: 2, lastActivity: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000) },
  { id: 'U004', name: 'Emily Davis', role: 'Admin', department: 'IT', completedCourses: 15, totalRequired: 15, overdueCourses: 0, lastActivity: new Date(Date.now() - 0.5 * 24 * 60 * 60 * 1000) },
  { id: 'U005', name: 'James Wilson', role: 'Analyst', department: 'Security', completedCourses: 9, totalRequired: 12, overdueCourses: 1, lastActivity: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000) },
];
...
const getCategoryColor = (category: CourseCategory) => {
  switch (category) {
    ...
    case 'role-specific': return 'bg-orange-500/20 text-orange-400';
    case 'leadership': return 'bg-cyan-500/20 text-cyan-400';
  }
};
...
const getStatusColor = (status: CourseStatus) => {
  switch (status) {
    ...
    case 'not-started': return 'bg-neutral-500/20 text-neutral-400 border-neutral-500/30';
...
const getCertStatusColor = (status: CertificationStatus) => {
  switch (status) {
    case 'valid': return 'bg-green-500/20 text-green-400 border-green-500';
    case 'expiring-soon': return 'bg-yellow-500/20 text-yellow-400 border-yellow-500';
    case 'expired': return 'bg-red-500/20 text-red-400 border-red-500';
    case 'not-certified': return 'bg-neutral-500/20 text-neutral-400 border-neutral-600';
  }
};
...
export const TrainingPage: React.FC = () => {
  ...
  const overdueCourses = mockCourses.filter(c => c.required && c.dueDate && c.dueDate < new Date() && c.status !== 'completed');
      ...
      {activeTab === 'my-learning' && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-4 gap-4">
            {[
              { label: 'Completed Courses', value: mockCourses.filter(c => c.status === 'completed').length, total: mockCourses.length, color: 'text-green-400', icon: '✅' },
              { label: 'Required Complete', value: completedRequired, total: requiredCourses.length, color: 'text-blue-400', icon: '📋' },
              { label: 'In Progress', value: mockCourses.filter(c => c.status === 'in-progress').length, color: 'text-yellow-400', icon: '📖' },
              { label: 'Overdue', value: overdueCourses.length, color: overdueCourses.length > 0 ? 'text-red-400' : 'text-green-400', icon: '⚠️' },
            ].map(stat => (
              <div key={stat.label} className="bg-neutral-800 rounded-xl border border-neutral-700 p-6">
          ...
          <div className="bg-neutral-800 rounded-xl border border-neutral-700 p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              {mockLearningPaths.map(path => (
                <div key={path.id} className="p-4 bg-neutral-900 rounded-lg border border-neutral-700">
            ...
            <div className="bg-neutral-800 rounded-xl border border-neutral-700 p-6">
              ...
              <div className="space-y-2">
                {mockCourses
                  ...
                  .map(course => (
                    <div key={course.id} className="flex items-center justify-between p-3 bg-neutral-900 rounded-lg">
                      <div className="flex items-center gap-3">
                        <span className={`w-2 h-2 rounded-full ${
                          course.dueDate && course.dueDate < new Date() ? 'bg-red-500' :
                          course.dueDate && course.dueDate < new Date(Date.now() + 7 * 24 * 60 * 60 * 1000) ? 'bg-yellow-500' :
                          'bg-green-500'
                        }`}></span>
                        <span>{course.title}</span>
                      </div>
                      <span className={`text-sm ${
                        course.dueDate && course.dueDate < new Date() ? 'text-red-400 font-medium' : 'text-neutral-400'
                      }`}>
                ...
                <div key={cert.id} className="p-4 bg-neutral-900 rounded-lg">
                  ...
                  <div className="space-y-2">
                    {cert.courses.map(courseId => {
                      ...
                      return (
                        <div key={courseId} className="flex items-center justify-between p-2 bg-neutral-800 rounded">
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-4 gap-4">
            {[
              ...
              { label: 'Fully Compliant', value: mockTeamMembers.filter(m => m.completedCourses >= m.totalRequired).length, icon: '✅' },
              { label: 'With Overdue', value: mockTeamMembers.filter(m => m.overdueCourses > 0).length, color: 'text-red-400', icon: '⚠️' },
              { label: 'Avg Completion', value: `${Math.round(mockTeamMembers.reduce((acc, m) => acc + (m.completedCourses / m.totalRequired), 0) / mockTeamMembers.length * 100)}%`, icon: '📊' },
            ].map(stat => (
              <div key={stat.label} className="bg-neutral-800 rounded-xl border border-neutral-700 p-6">
                <span className="text-2xl">{stat.icon}</span>
            ...
            <table className="w-full">
              ...
              <tbody>
                {mockTeamMembers.map(member => (
                  <tr key={member.id} className="border-t border-neutral-700 hover:bg-neutral-700/50 cursor-pointer transition-colors">
                        ...
                        <div className="w-24 h-2 bg-neutral-700 rounded-full overflow-hidden">
                          <div 
                            className={`h-full rounded-full ${
                              member.completedCourses >= member.totalRequired ? 'bg-green-500' : 'bg-primary-500'
                            }`}
                            style={{ width: `${(member.completedCourses / member.totalRequired) * 100}%` }}
                          />
                        </div>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 gap-6">
                    ...
                    <div key={category}>
                      ...
                      <div className="h-2 bg-neutral-700 rounded-full overflow-hidden">
                        <div 
                          ...
                          style={{ width: courses.length > 0 ? `${(completed / courses.length) * 100}%` : '0%' }}
                        />
                      </div>
                    </div>
                  );
            ...
            <div className="bg-neutral-800 rounded-xl border border-neutral-700 p-6">
              ...
              <div className="space-y-3">
                {[
                  { label: 'Export Compliance Report', icon: '📄', action: 'PDF report of all training status' },
                  { label: 'Send Reminders', icon: '📧', action: 'Notify users with overdue training' },
                  { label: 'Schedule Training', icon: '📅', action: 'Bulk assign courses to team' },
                  { label: 'Audit Trail Export', icon: '📋', action: 'Download completion certificates' },
                ].map(action => (
                  <button
                    key={action.label}
          ...
          <div className="bg-neutral-800 rounded-2xl border border-neutral-700 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 border-t border-neutral-700 flex justify-end gap-3">
              ...
              <button className="px-4 py-2 bg-primary-600 text-white rounded-lg font-medium hover:bg-primary-700 transition-colors">
                {selectedCourse.status === 'not-started' ? 'Start Course' : 
