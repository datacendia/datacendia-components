...
export const DecisionsPage: React.FC = () => {
  ...
  const loadDecisions = async () => {
    ...
    try {
      ...
      setDecisions([
        { id: 'dec-001', question: 'Should we expand into the European market in Q2?', mode: 'deliberation', status: 'completed', confidence: 0.87, agentCount: 6, createdAt: new Date(Date.now() - 86400000).toISOString(), completedAt: new Date(Date.now() - 82800000).toISOString(), synthesis: 'The Council recommends proceeding with EU expansion, prioritizing Germany and Netherlands. Risk-adjusted ROI projects 34% within 18 months.' },
        { id: 'dec-002', question: 'Evaluate the acquisition of DataSync Corp for $12M', mode: 'deliberation', status: 'completed', confidence: 0.72, agentCount: 8, createdAt: new Date(Date.now() - 172800000).toISOString(), completedAt: new Date(Date.now() - 169200000).toISOString(), synthesis: 'Split recommendation: CFO and COO agents favor acquisition for talent and IP. CISO agent flagged security concerns in target codebase. Recommend due diligence extension.' },
        { id: 'dec-003', question: 'What is the optimal pricing strategy for Enterprise tier?', mode: 'deliberation', status: 'completed', confidence: 0.91, agentCount: 5, createdAt: new Date(Date.now() - 259200000).toISOString(), completedAt: new Date(Date.now() - 255600000).toISOString(), synthesis: 'Consensus on value-based pricing at $2,400/seat/year with volume discounts. Projects 28% increase in enterprise pipeline conversion.' },
        { id: 'dec-004', question: 'Risk assessment for migrating to multi-region infrastructure', mode: 'quick', status: 'completed', confidence: 0.83, agentCount: 7, createdAt: new Date(Date.now() - 345600000).toISOString(), completedAt: new Date(Date.now() - 342000000).toISOString(), synthesis: 'Red team identified 3 critical risks: data sovereignty gaps, latency spikes during failover, and compliance gaps in APAC region. Mitigation plan provided.' },
        { id: 'dec-005', question: 'Should we build or buy a customer data platform?', mode: 'deliberation', status: 'in_progress', confidence: 0.45, agentCount: 6, createdAt: new Date(Date.now() - 3600000).toISOString() },
      ]);
      setError(null);
    } finally {
      setIsLoading(false);
