/**
 * Page — Council Modes Page
 *
 * React page component rendered by the router.
 *
 * @exports CouncilModesPage
 * @module pages/cortex/council/CouncilModesPage
 */
    ...
    <div className="p-4 lg:p-6 max-w-[1440px] mx-auto space-y-5">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <h1 className="text-2xl" style={{ fontFamily: 'Arial, Helvetica, sans-serif', fontWeight: 300, letterSpacing: '0.35em', color: '#e8e4e0' }}>COUNCIL MODES</h1>
