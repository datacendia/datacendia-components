/**
 * Page — R D P Service Page
 *
 * React page component rendered by the router.
 *
 * @exports RDPServicePage
 * @module pages/cortex/intelligence/RDPServicePage
 */
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <h1 className="text-2xl flex items-center gap-2" style={{ fontFamily: 'Arial, Helvetica, sans-serif', fontWeight: 300, letterSpacing: '0.35em', color: '#e8e4e0' }}>
            <BookOpen className="w-5 h-5 text-indigo-400" /> CENDIARDP<span style={{ fontWeight: 200, fontSize: '0.7em', opacity: 0.5, marginLeft: '2px' }}>™</span>
          </h1>
