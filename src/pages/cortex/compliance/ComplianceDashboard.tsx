...
const FiveRingsVisualization: React.FC<{ rings: Ring[] }> = ({ rings }) => {
  return (
    <div className="relative w-full max-w-2xl mx-auto aspect-square">
      ...
      {/* Center - 8 Pillars */}
      <div
        className="absolute rounded-full bg-gradient-to-br from-primary-500 to-primary-700 shadow-xl flex flex-col items-center justify-center text-white"
...
// Ring Card Component
const RingCard: React.FC<{ ring: Ring; onRunAssessment: (domain: ComplianceDomain) => void }> = ({
  ring,
  onRunAssessment,
}) => {
  ...
  return (
    <div
      className={`bg-white rounded-xl border border-neutral-200 overflow-hidden transition-all duration-300 ${expanded ? 'shadow-lg' : 'hover:shadow-md'}`}
    >
      <div
...
const ComplianceDashboard: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="opacity-80 mt-2">
              {summary.assessments.total} assessments across 5 domains
            </p>
          </div>
      ...
      {/* Five Rings Grid */}
      <div>
        <h2 className="text-lg font-semibold text-neutral-900 mb-4">Compliance Domains</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {summary.fiveRings.map((ring) => (
            <RingCard key={ring.ring} ring={ring} onRunAssessment={runAssessment} />
          ))}
        </div>
      </div>
      ...
      {bundleId && (
        <div className="bg-green-50 border border-green-200 rounded-xl p-6">
          ...
          <p className="text-green-700 text-sm mb-4">
            Your compliance bundle has been generated with all framework reports, audit logs, and
      ...
      <div className="grid md:grid-cols-4 gap-4">
        <Link
          to="/cortex/compliance/frameworks"
          className="block p-4 bg-white rounded-xl border border-neutral-200 hover:shadow-md transition-shadow"
        >
        ...
        <Link
          to="/cortex/compliance/assessments"
          className="block p-4 bg-white rounded-xl border border-neutral-200 hover:shadow-md transition-shadow"
        >
          <span className="text-2xl">📋</span>
