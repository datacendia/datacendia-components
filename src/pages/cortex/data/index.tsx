 ...
 *
 * @exports DataSourcesPage, DataCatalogPage, DataQualityPage, DataImportExportPage
 * @module pages/cortex/data/index
 */
    ...
    <div className="p-6 lg:p-8 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-[11px] uppercase tracking-[0.25em] text-white/60 font-light">Browse and manage your data assets</p>
        </div>
        <div className="flex items-center gap-2">
          <button
    ...
    <div className="p-6 lg:p-8 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-[11px] uppercase tracking-[0.25em] text-white/60 font-light">Monitor and improve data quality across sources</p>
        </div>
