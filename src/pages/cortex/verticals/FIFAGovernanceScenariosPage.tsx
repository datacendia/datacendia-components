      ...
      <div className="space-y-3">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-[11px] uppercase tracking-[0.25em] text-white/60 font-light">{scenario.subtitle}</p>
          </div>
        </div>
              ...
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] uppercase tracking-[0.25em] text-white/60 font-light">Institutional Protection Under Scrutiny</p>
                  </div>
                </div>
              </div>
              <Button
