    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-neutral max-w-none">
          ...
          {/* Subscription */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 mb-4">4. Subscription and Payment</h2>
            
            <h3 className="text-lg font-semibold text-neutral-900 mb-3">4.1 Subscription Plans</h3>
            <p className="text-neutral-600 mb-4">
              The Services are offered on a subscription basis. Your subscription includes access 
              to the features specified in your plan. We reserve the right to modify plans with 
              reasonable notice.
            </p>
            ...
            <p className="text-neutral-600">
              We may change prices with at least 30 days' notice. Price changes take effect 
          ...
          <section className="mb-12">
            ...
            <p className="text-neutral-600 mb-4">
              You retain all rights to your data. By uploading data to the Services, you grant 
              us a limited license to host, store, process, and display your data solely to 
              provide the Services.
            </p>

            <h3 className="text-lg font-semibold text-neutral-900 mb-3">6.2 Data Processing</h3>
            <p className="text-neutral-600 mb-4">
              We process your data in accordance with our Data Processing Agreement and 
              Privacy Policy. For EU/EEA customers, we act as a data processor.
            </p>

            <h3 className="text-lg font-semibold text-neutral-900 mb-3">6.3 Data Portability</h3>
            <p className="text-neutral-600">
              You may export your data at any time through the platform. Upon termination, 
          ...
          <section className="mb-12">
            ...
            <p className="text-neutral-600 mb-4">
              The Services, including all software, content, trademarks, and technology, are 
              owned by Datacendia or our licensors. Nothing in these Terms grants you any 
              rights except the limited license to use the Services.
            </p>
            ...
            <p className="text-neutral-600">
              ...
              license to use and incorporate such feedback into our Services.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-neutral-600 mb-4">
              ...
              provision of Services. Confidential information includes pricing, technical 
              details, and business information not publicly available.
            </p>
            <p className="text-neutral-600">
          ...
          {/* Warranties */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-neutral-900 mb-4">9. Warranties and Disclaimers</h2>
            ...
            <p className="text-neutral-600 uppercase font-semibold">
              EXCEPT AS EXPRESSLY PROVIDED, THE SERVICES ARE PROVIDED "AS IS" WITHOUT WARRANTY 
              OF ANY KIND. WE DISCLAIM ALL IMPLIED WARRANTIES INCLUDING MERCHANTABILITY, 
          ...
          <section className="mb-12">
            ...
            <p className="text-neutral-600 mb-4 uppercase font-semibold">
              ...
              OF PROFITS, REVENUE, DATA, OR USE, WHETHER IN CONTRACT, TORT, OR OTHERWISE.
            </p>
            <p className="text-neutral-600 uppercase font-semibold">
          ...
          <section className="mb-12">
            ...
            <p className="text-neutral-600">
              You agree to indemnify and hold harmless Datacendia from any claims, damages, 
              and expenses arising from: (a) your use of the Services, (b) your violation of 
              these Terms, (c) your violation of any third-party rights, or (d) your data.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-neutral-600 mb-4">
              We may suspend or terminate your access if you breach these Terms, fail to pay 
              fees, or if required by law. We will provide notice except in cases of emergency.
            </p>

            <h3 className="text-lg font-semibold text-neutral-900 mb-3">12.3 Effect of Termination</h3>
            <p className="text-neutral-600">
              Upon termination, your right to use the Services ceases. You may export your data 
              for 30 days. Provisions that should survive termination will survive.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-neutral-600 mb-4">
              We may modify these Terms with notice. Material changes will be announced at 
              least 30 days in advance. Continued use constitutes acceptance.
            </p>

            <h3 className="text-lg font-semibold text-neutral-900 mb-3">13.4 Entire Agreement</h3>
            <p className="text-neutral-600 mb-4">
              These Terms, together with our Privacy Policy and any Order Form, constitute 
              the entire agreement between you and Datacendia.
            </p>
          ...
          <section className="mb-12">
            ...
            <div className="bg-neutral-50 rounded-lg p-6">
              ...
              <p className="text-neutral-600 mt-4">
                Email: <a href="mailto:legal@datacendia.com" className="text-primary-600">legal@datacendia.com</a>
              </p>
            </div>
          </section>
        </div>
