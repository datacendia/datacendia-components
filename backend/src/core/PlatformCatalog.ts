...
export const PLATFORM_PILLARS: Record<PillarId, PillarDefinition> = {
  ...
  dcii: {
    ...
    services: [
      ...
      { id: 'evidence_export', name: 'Evidence Export', description: 'forensic-grade, independently verifiable PDF bundles', category: 'tool' },
      { id: 'regulators_receipt', name: "Regulator's Receipt™", trademarkedName: "Regulator's Receipt™", description: 'One-click forensic-grade, independently verifiable PDF — the demo moment', category: 'tool' },
