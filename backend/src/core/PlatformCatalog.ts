...
export const PLATFORM_PILLARS: Record<PillarId, PillarDefinition> = {
  ...
  council: {
    ...
    description: 'Multi-agent AI deliberation system. 15 C-Suite agents debate decisions with cross-examination, veto powers, and real-time visualization.',
    icon: '🧠',
    color: '#3B82F6',
    services: [
      { id: 'core_agents', name: 'Core 15 C-Suite Agents', description: 'CFO, CTO, CISO, CLO, COO, CMO, CHRO, CRO, CDO, CPO, CSO, CIO, CCO, CAO, CKO debate decisions', category: 'agent' },
      ...
      { id: 'council_modes', name: '35+ Council Modes', description: 'War Room, Crisis, Due Diligence, Innovation Lab, Compliance, etc.', category: 'core' },
