...
/**
 * POST /api/gateway/federation
 * Create a new federation (e.g. FEPCMAC → 11 Cajas Municipales).
 */
...
/**
 * GET /api/gateway/federation/:id/dashboard
 * Federation compliance dashboard — consolidated view for regulatory reporting.
 */
...
/**
 * POST /api/gateway/federation/:id/members
 * Add a member organization to the federation.
 */
...
/**
 * GET /api/gateway/federation/:id/members
...
/**
 * DELETE /api/gateway/federation/:id/members/:orgId
...
/**
 * POST /api/gateway/federation/:id/policies
 * Add a shared governance policy to the federation.
 */
...
/**
 * GET /api/gateway/federation/:id/policies
 * List federation policies (optionally filtered by org).
 */
...
/**
 * GET /api/gateway/federation/:id/members/:orgId/stats
 * Get per-member compliance stats.
 */
...
/**
 * POST /api/gateway/federation/:id/reports
 * Generate a consolidated compliance report for the federation.
 * Designed for regulatory submission (e.g. to SBS for DS 115-2025-PCM).
 */
...
/**
 * POST /api/gateway/federation/:id/interaction
 * Record an interaction from a member org (used by gateway middleware).
 */
