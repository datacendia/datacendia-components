/**
 * CendiaNexusService Tests
 * @module __tests__/services/CendiaNexusService.test
 */
...
const mod = await import('../../services/enterprise/CendiaNexusService.js');
const service = (mod as any).cendiaNexusService || (mod as any).default;

describe('CendiaNexusService', () => {
