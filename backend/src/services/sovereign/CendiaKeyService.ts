/**
 * Service — Cendia Key Service
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports CendiaKeyService, cendiaKeyService, HardwareKey, AuthChallenge, HighRiskOperation, OperationAttempt, KeyAuditLog
 * @module services/sovereign/CendiaKeyService
 */
