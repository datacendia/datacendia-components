/**
 * Service — Cendia Mirage Service
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports CendiaMirageService, cendiaMirageService, Honeytoken, CanarySystem, CanaryAlert, SandboxEnvironment, RedirectRule, CapturedActivity
 * @module services/sovereign/CendiaMirageService
 */
