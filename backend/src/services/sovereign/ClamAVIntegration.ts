/**
 * Service — Clam A V Integration
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports ClamAVIntegration, clamAVIntegration, ScanResult, ClamAVConfig, ThreatLevel
 * @module services/sovereign/ClamAVIntegration
 */
