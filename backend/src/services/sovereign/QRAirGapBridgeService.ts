/**
 * Service — Q R Air Gap Bridge Service
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports qrAirGapBridgeService, QRPayload, QRChunk, QRSequence, CaptureSession, BridgeConfig
 * @module services/sovereign/QRAirGapBridgeService
 */
...
class QRAirGapBridgeService extends EventEmitter {
  ...
  private async renderQRFrames(chunks: QRChunk[]): Promise<string[]> {
    ...
    for (const chunk of chunks) {
      ...
      // QR generation via qrcode library when installed
