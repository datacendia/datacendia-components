/**
 * Service — Cendia Mirror Service
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports CendiaMirrorService, cendiaMirrorService, DigitalTwinState, StateSnapshot, SimulationScenario, SimulationResult, PropagationAnalysis
 * @module services/sovereign/CendiaMirrorService
 */
