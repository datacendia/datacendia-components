/**
 * Service — Cendia Vault Service
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports CendiaVaultService, cendiaVaultService, VaultArtifact, AccessLogEntry, VaultStats, VaultSearchQuery, VaultExportOptions, ArtifactType
 * @module services/sovereign/CendiaVaultService
 */
