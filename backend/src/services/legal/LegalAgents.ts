/**
 * Service — Legal Agents
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports getLegalAgent, getDefaultLegalAgents, getOptionalLegalAgents, getLegalAgentsByExpertise, getAdversarialAgents, getCitationRequiredAgents, buildLegalAgentTeam, getSilentGuardAgents
 * @module services/legal/LegalAgents
 */
