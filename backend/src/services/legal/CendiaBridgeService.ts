/**
 * Service — Cendia Bridge Service
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports CendiaBridgeService, cendiaBridgeService, Connector, ConnectorConfig, IngestJob, IngestedItem, SyncResult, ConnectorType
 * @module services/legal/CendiaBridgeService
 */
