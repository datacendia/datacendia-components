 ...
 *
 * @exports DEFAULT_APOTHEOSIS_CONFIG, ApotheosisRun, WeaknessItem, AutoPatch, Escalation, UpskillAssignment, LearningModule, PatternBan
 * @module services/apotheosis/types
 */
