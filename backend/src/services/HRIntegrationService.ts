/**
 * Service — H R Integration Service
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports hrIntegrationService, HRCredentials, HREmployee, HRTimeEntry, HRSyncResult, HRConnectionStatus, HRProvider
 * @module services/HRIntegrationService
 */
