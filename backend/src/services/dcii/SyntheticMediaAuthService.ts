 ...
 *
 * @exports syntheticMediaAuthService, MediaAsset, ProvenanceRecord, C2PAAssertion, C2PAIngredient, HardwareAttestation, CustodyEntry, AuthenticityAssessment
 * @module services/dcii/SyntheticMediaAuthService
 */
