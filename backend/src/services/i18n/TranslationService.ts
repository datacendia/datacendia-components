 ...
 *
 * @exports SUPPORTED_LANGUAGES, BASE_TRANSLATIONS, translationService, SupportedLanguage
 * @module services/i18n/TranslationService
 */
...
import { redis } from '../../config/redis.js'; // 1 hour cache for translations
...
Translation:`;
  ...
  private async getFromDatabase(language: string): Promise<Record<string, string> | null> {
    try {
      // @ts-ignore - Prisma model may not be generated yet
