/**
 * Service — Gnosis Service
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports gnosisService, LearningPath, LearningModule, ModuleContent, QuizQuestion, SimulationConfig, UserSkillProfile, SkillLevel
 * @module services/gnosisService
 */
