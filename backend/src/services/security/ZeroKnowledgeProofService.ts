 ...
 *
 * @exports ZeroKnowledgeProofService, zeroKnowledgeProofService, ZKProofRequest, ZKProof, ProofVerificationResult, ComplianceCertificate, ProofType, ProofStatus
 * @module services/security/ZeroKnowledgeProofService
 */
...
import { sha256, bytesToHex } from '../crypto/nativeCrypto.js';
