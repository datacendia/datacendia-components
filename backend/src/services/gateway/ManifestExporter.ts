/**
 * CendiaGateway™ — AI Manifest Exporter
 *
 * Generates print-ready HTML documents from AI Manifests that can be
 * saved as PDF by the browser or wkhtmltopdf. Designed for auditors,
 * regulators, and board presentations.
 *
...
class ManifestExporter {
  ...
  /**
   * Generate a self-contained HTML document from an AI Manifest.
   * The HTML is print-optimized and can be saved as PDF via browser print dialog.
   */
...
<head>
  ...
  <title>AI Usage Attestation — ${manifest.organizationName} — ${periodStart} to ${periodEnd}</title>
  <style>
...
<body>
  <div class="container">
    ...
    <div class="signature-block">
      <h2>7. Attestation</h2>
      <p>I attest that the information contained in this AI Usage Attestation is accurate and complete to the best of my knowledge. The cryptographic integrity of this document has been verified using the CendiaGateway™ DCII evidence framework.</p>
    ...
    <div class="footer">
      <p>Generated by CendiaGateway™ — Datacendia Decision Governance Infrastructure</p>
      <p>Format Version: ${manifest.formatVersion} | Manifest ID: ${manifest.id}</p>
  ...
  /**
   * Generate a JSON export of the manifest (machine-readable).
   */
