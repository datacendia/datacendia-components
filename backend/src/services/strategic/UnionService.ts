 ...
 *
 * @exports unionService, ThreatAssessment, Threat, DefenseStrategy, Defense, Mitigation, MonitoringPoint, ResponsePlaybook
 * @module services/strategic/UnionService
 */
