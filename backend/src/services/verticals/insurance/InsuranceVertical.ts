/**
 * Service — Insurance Vertical
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports BiasFairnessEngine, InsuranceDataConnector, InsuranceKnowledgeBase, InsuranceComplianceMapper, UnderwritingDecisionSchema, ClaimDecisionSchema, UnderwritingAgentPreset, InsuranceDefensibleOutput
 * @module services/verticals/insurance/InsuranceVertical
 */
