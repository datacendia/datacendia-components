/**
 * Service — Manufacturing Vertical
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports ManufacturingDataConnector, ManufacturingKnowledgeBase, ManufacturingComplianceMapper, productionDecisionSchema, qualityApprovalSchema, safetyEscalationSchema, PortfolioRebalanceSchema, productionAnalysisAgentPreset
 * @module services/verticals/manufacturing/ManufacturingVertical
 */
  ...
  getStatus(): {
    ...
    return {
      ...
      layers: {
        ...
        complianceMapper: true, // —Å"… 6 frameworks: ISO 9001|IATF 16949|OSHA|FDA QSR|AS9100/IV, SR 11-7, safety-BSA, ISO 9001|IATF 16949|OSHA|FDA QSR|AS9100, ISO 9001|IATF 16949|OSHA|FDA QSR|AS9100
        decisionSchemas: true, // —Å"… 4 schemas: production, quality, safety, Rebalance
        agentPresets: true, // —Å"… 4 presets: production, quality, safety, Rebalance workflows
