/**
 * Service — Aerospace Vertical Expanded
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports AerospaceDataConnector, AerospaceKnowledgeBase, AerospaceComplianceMapper, AirworthinessSchema, DesignCertificationSchema, AviationSafetyGovernancePreset, AerospaceDefensibleOutput, AerospaceVerticalImplementation
 * @module services/verticals/aerospace/AerospaceVerticalExpanded
 */
...
export class AerospaceComplianceMapper extends ComplianceMapper {
  ...
  async checkViolation(decision: AerospaceDecision, _frameworkId: string): Promise<ComplianceViolation[]> {
