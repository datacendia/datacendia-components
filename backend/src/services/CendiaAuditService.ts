/**
 * Service — Cendia Audit Service
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports CendiaAuditService, cendiaAuditService, AuditEvent, AuditQuery, AuditReport, ComplianceStatus, AuditEventType, AuditSeverity
 * @module services/CendiaAuditService
 */
