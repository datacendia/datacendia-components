 ...
 *
 * @exports SimulationConfig, SimulationVariable, SimulationConstraint, VariableCorrelation, ScenarioDefinition, Shock, Trigger, SimulationResult
 * @module services/crucible/types
 */
