/**
 * Service — S B O M Service
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports SBOMService, sbomService, Package, Vulnerability, LicenseInfo, SBOMReport, SBOMFormat
 * @module services/crucible/SBOMService
 */
...
// ============================================================================
// KNOWN VULNERABILITIES DATABASE (NVD/OSV API integration via DataConnectorFramework)
// ============================================================================
...
export class SBOMService extends EventEmitter {
  ...
  private checkVulnerabilities(name: string, version: string): Vulnerability[] {
    ...
    // Semver comparison via semver library (npm install semver)
