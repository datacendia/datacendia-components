...
import type { CustomerProfile, CustomerHealth, HealthComponent, RiskFactor, SuccessOpportunity, RecommendedAction, ChurnPrediction, ChurnDriver, CarePackage, PackageComponent, CustomerEngagement, SuccessPlaybook } from './guardian-types.js';
export type { CustomerProfile, CustomerHealth, HealthComponent, RiskFactor, SuccessOpportunity, RecommendedAction, ChurnPrediction, ChurnDriver, CarePackage, PackageComponent, CustomerEngagement, SuccessPlaybook } from './guardian-types.js';
...
- win_back: re-engage churned customer`;
   ...
   */
    // Extended methods extracted to guardian-methods.ts
