/**
 * Service — Cendia Equity Service
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports cendiaEquityService, MarketSentiment, AnalystRatings, NewsImpact, InsiderActivity, EarningsSimulation, EarningsCallPrep, MetricHighlight
 * @module services/enterprise/CendiaEquityService
 */
