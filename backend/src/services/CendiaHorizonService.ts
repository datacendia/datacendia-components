/**
 * Service — Cendia Horizon Service
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports cendiaHorizonService, cascadeService, OracleQuery, OracleSimulation, Universe, TimelineEvent, CascadeEffect, AgentInsight
 * @module services/CendiaHorizonService
 */
...
class CendiaHorizonServiceClass extends EventEmitter {
   ...
   */
    // Extended methods extracted to horizon-methods.ts
