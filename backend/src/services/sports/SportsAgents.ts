/**
 * Service — Sports Agents
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports SPORTS_AGENT_PRESETS, sportsAgentService, SportsAgentPreset, AgentResponse, WorkflowContext, SportsAgentRole, SportsWorkflow
 * @module services/sports/SportsAgents
 */
