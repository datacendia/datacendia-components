 ...
 *
 * @exports HealthService, healthService, SystemHealth, HealthDimension, ComponentHealth, HealthAlert, HealthTrend, HealthStatus
 * @module services/pillars/HealthService
 */
