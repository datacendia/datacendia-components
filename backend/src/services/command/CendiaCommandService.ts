/**
 * Service — Cendia Command Service
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports CendiaCommandService, VERTICAL_CONFIGS, cendiaCommandService, CommandContext, QuickAction, CommandIntent, CommandExecution, CommandSuggestion
 * @module services/command/CendiaCommandService
 */
