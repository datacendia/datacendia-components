/**
 * Service — Feature Control Service
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports featureControlService, FeatureConfig, AgentConfig, SuiteConfig, PricingTier, FeatureType, FeatureStatus, VisibilityLevel
 * @module services/admin/FeatureControlService
 */
