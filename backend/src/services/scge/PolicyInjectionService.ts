/**
 * Service — Policy Injection Service
 *
 * Business logic service implementing platform capabilities.
 *
 * @exports PolicyInjectionService, DEFAULT_POLICY_TEMPLATES, policyInjectionService
 * @module services/scge/PolicyInjectionService
 */
