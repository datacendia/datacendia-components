...
export const VERTICAL_AGENT_MAPPINGS: AgentModelMapping[] = [
  ...
  { agentCode: 'retail-category', agentName: 'CategoryManager', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Optimize category assortment. Drive category growth through data-driven decisions.', optimalTemperature: 0.4, useChainOfThought: true, useEnsemble: false },
  { agentCode: 'retail-pricing', agentName: 'RetailPricing', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Balance competitive pricing with profitability. Optimize markdowns.', optimalTemperature: 0.3, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'retail-analytics', agentName: 'RetailAnalytics', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Transform retail data into insights. Drive data-driven retail decisions.', optimalTemperature: 0.3, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'retail-cfo', agentName: 'RetailFinance', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Drive profitable retail growth. Optimize margin and capital allocation.', optimalTemperature: 0.3, useChainOfThought: true, useEnsemble: false },

  // REAL ESTATE / CONSTRUCTION - 23 Agents
  { agentCode: 're-development', agentName: 'DevelopmentStrategy', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Lead real estate development. Optimize project feasibility and execution.', optimalTemperature: 0.4, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 're-investment', agentName: 'REInvestment', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Drive risk-adjusted returns. Make disciplined investment decisions.', optimalTemperature: 0.4, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 're-asset-mgmt', agentName: 'AssetManagement', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Maximize asset value. Drive value creation through active management.', optimalTemperature: 0.4, useChainOfThought: true, useEnsemble: false },
  { agentCode: 're-capital-markets', agentName: 'RECapitalMarkets', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Optimize capital structure. Manage debt, equity, and investor relations.', optimalTemperature: 0.4, useChainOfThought: true, useEnsemble: false },
  { agentCode: 're-research', agentName: 'REResearch', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Provide market insights. Analyze trends and competitive intelligence.', optimalTemperature: 0.4, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 're-project-finance', agentName: 'REProjectFinance', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Structure deals optimally. Manage construction financing and project finance.', optimalTemperature: 0.4, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 're-valuation', agentName: 'Valuation', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Provide accurate valuations. Analyze market value and highest/best use.', optimalTemperature: 0.3, useChainOfThought: true, useEnsemble: false },
  { agentCode: 're-risk', agentName: 'RERisk', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Manage risk and protect value. Analyze portfolio and climate risk.', optimalTemperature: 0.3, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'trans-routing', agentName: 'RouteOptimizer', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Optimize routes for efficiency. Balance cost and service levels.', optimalTemperature: 0.3, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'trans-supply-chain', agentName: 'SupplyChainStrategy', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Optimize end-to-end supply chain. Drive visibility and network optimization.', optimalTemperature: 0.4, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'trans-finance', agentName: 'TransFinance', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Drive profitable operations. Optimize cost per mile and pricing.', optimalTemperature: 0.3, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'trans-analytics', agentName: 'TransAnalytics', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Drive data-driven decisions. Transform transportation data into insights.', optimalTemperature: 0.3, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'sports-performance', agentName: 'PerformanceAnalyst', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Analyze athletic performance metrics. Optimize training loads. Prevent injuries through data analysis.', optimalTemperature: 0.4, useChainOfThought: true, useEnsemble: false },
  { agentCode: 'sports-scouting', agentName: 'ScoutingDirector', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Evaluate player talent. Analyze draft prospects. Assess fit with team system and culture.', optimalTemperature: 0.5, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'sports-analytics', agentName: 'SportsAnalytics', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Transform data into insights. Develop advanced metrics. Build predictive models for performance.', optimalTemperature: 0.3, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'sports-cfo', agentName: 'SportsFinance', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Manage team finances. Optimize budgets. Ensure financial sustainability and profitability.', optimalTemperature: 0.3, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'edu-enrollment', agentName: 'EnrollmentManager', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Optimize enrollment strategy. Manage admissions funnel. Maximize yield and retention.', optimalTemperature: 0.4, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'edu-research', agentName: 'ResearchAdmin', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Enable research excellence. Manage grants and compliance. Support technology transfer.', optimalTemperature: 0.4, useChainOfThought: true, useEnsemble: false },
  { agentCode: 'edu-cfo', agentName: 'EducationFinance', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Ensure financial sustainability. Manage budgets and endowment. Optimize tuition strategy.', optimalTemperature: 0.3, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'edu-strategy', agentName: 'StrategicPlanning', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Shape institutional future. Lead strategic planning. Ensure accreditation and effectiveness.', optimalTemperature: 0.5, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'media-analytics', agentName: 'AudienceAnalytics', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Analyze audience data. Measure engagement. Build predictive models for content performance.', optimalTemperature: 0.3, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'media-streaming', agentName: 'StreamingStrategy', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Drive streaming growth. Optimize subscriber acquisition and retention. Plan content investment.', optimalTemperature: 0.5, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'media-cfo', agentName: 'MediaFinance', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Ensure profitable content investment. Manage budgets and ROI analysis.', optimalTemperature: 0.3, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'ps-quality-risk', agentName: 'QualityRisk', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Protect firm reputation. Manage quality control and risk. Ensure independence.', optimalTemperature: 0.3, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'ps-pricing', agentName: 'PricingStrategy', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Capture value through pricing. Optimize fee arrangements and profitability.', optimalTemperature: 0.4, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'ps-cfo', agentName: 'FirmFinance', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Ensure profitable growth. Manage firm finances and partner compensation.', optimalTemperature: 0.3, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'ps-strategy', agentName: 'FirmStrategy', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Set strategic direction. Drive market positioning and competitive advantage.', optimalTemperature: 0.5, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'ps-audit', agentName: 'AuditAssurance', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Provide independent assurance. Conduct audits with professional skepticism.', optimalTemperature: 0.3, useChainOfThought: true, useEnsemble: false },
  { agentCode: 'ps-tax', agentName: 'TaxAdvisory', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Provide tax-efficient strategies. Ensure compliance and optimize structures.', optimalTemperature: 0.3, useChainOfThought: true, useEnsemble: false },
  ...
  { agentCode: 'ps-restructuring', agentName: 'Restructuring', primaryModel: 'qwq:32b', fallbackModels: ['qwen3:32b'], systemPromptEnhancements: 'Restore value in distressed situations. Lead turnaround and restructuring.', optimalTemperature: 0.4, useChainOfThought: true, useEnsemble: false },
];
